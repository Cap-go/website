...
head_image_alt: Comparison of OTA update delivery and traditional QA testing paths
...
| **User Experience** | [Automatic background updates](https://capgo.app/docs/plugins/updater/self-hosted/auto-update/) | Users manually update apps |
