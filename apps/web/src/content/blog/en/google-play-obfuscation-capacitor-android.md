...
updated_at: 2026-09-02T15:39:27.000Z
...
1. Open [R8 Configuration Analyzer](https://developer.android.com/topic/performance/app-optimization/r8-configuration-analyzer) if your Android Gradle Plugin is 9.3 or newer — `assembleRelease` then writes `configanalyzer.html` next to `mapping.txt`. On AGP 9.2 and earlier, skip that HTML file and use `mapping.txt`, APK Analyzer, and Play's App bundle explorer instead.
