...
head_image_alt: Native bridge flow between JavaScript and Android APIs
...
For more advanced optimization, try using a [channel system](https://capgo.app/docs/live-updates/channels/) for update distribution. This method allows you to test updates with smaller user groups first, making it easier to monitor performance before rolling out changes to everyone.
...
-   **Controlled Rollouts**: Use [channel-based update systems](https://capgo.app/docs/live-updates/channels/) to distribute updates to specific user groups before releasing them widely.
