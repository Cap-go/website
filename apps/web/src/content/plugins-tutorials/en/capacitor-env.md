...
# Complete Tutorial: Using @capgo/capacitor-env for iOS and Android Mobile Apps

The `@capgo/capacitor-env` package provides native env functionality for your Capacitor mobile applications on iOS and Android. This comprehensive tutorial will guide you through integrating env features into your iOS and Android mobile apps built with Capacitor or Cordova, enabling cross-platform mobile app development with native capabilities.

## What is Capacitor?

Capacitor is Ionic's modern native runtime that enables developers to build native iOS apps, Android apps, and Progressive Web Apps from a single codebase. Unlike older Cordova-based mobile development, Capacitor provides direct access to native iOS and Android APIs, making it the ideal choice for building production-ready mobile applications. This Capacitor plugin brings env capabilities to both iOS and Android mobile platforms.

## Why Use env in Your Capacitor Mobile App?

The @capgo/capacitor-env plugin enables your iOS and Android mobile applications to leverage native env functionality without writing platform-specific code. This Capacitor plugin provides a unified JavaScript API that works seamlessly on both iOS and Android mobile devices, making it perfect for cross-platform mobile app development.

Benefits for iOS and Android mobile applications:
- Native env performance on iOS and Android devices
...
- Uses native iOS APIs for env functionality
...
- Uses native Android APIs for env functionality
...
While this env plugin works with both Capacitor and Cordova mobile frameworks, Capacitor offers significant advantages for iOS and Android mobile app development:
...
You have successfully integrated @capgo/capacitor-env into your Capacitor mobile application for iOS and Android. This plugin provides native env capabilities for both iOS and Android mobile platforms, enabling professional mobile app development with a unified codebase.

For detailed API documentation and advanced env features for mobile app development, visit the [GitHub repository](https://github.com/Cap-go/capacitor-env).

Whether you're building native iOS apps, Android mobile applications, or cross-platform Capacitor mobile apps, this env plugin provides the native capabilities you need for professional mobile app development on iOS and Android platforms.
