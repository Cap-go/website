...
@capgo/transitions|github.com/Cap-go|Add Ionic-style page transitions and iOS edge swipe-back gestures without Ionic UI|https://github.com/Cap-go/capacitor-transitions/|Transitions
...
const pluginIconsByName: Record<string, string> = {
  ...
  '@capgo/transitions': 'ArrowsRightLeft',
