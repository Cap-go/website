...
const storyImage = (src: string, alt: string): RefusalStoryImage => ({ src, alt })

const storyImages = (entries: readonly [string, string][]): RefusalStoryImage[] =>
  entries.map(([src, alt]) => storyImage(src, alt))
...
export const refusalStories: RefusalStory[] = [
  {
    ...
    images: storyImages([
      [
        '/app-store-assets/adrien-target-users-refusal.svg',
  ...
  },
  {
    ...
    images: storyImages([
      [
        '/app-store-assets/adrien-saturated-category-refusal.svg',
  ...
  },
  {
    ...
    images: storyImages([
      [
        '/app-review-guide.webp',
        'App review guide screen used to represent an Apple App Store rejection workflow',
      ],
      ['/apple_appstore.webp', 'App Store publishing interface used to represent a delayed Apple review'],
    ]),
  },
  {
    ...
    images: storyImages([
      [
        '/native-build-assets/appstore-connect-manage-build.webp',
        'App Store Connect build management screen representing a post-approval release blocker',
      ],
      [
        '/native-build-assets/appstore-connect-manage-build-compliance.webp',
  ...
  },
  {
    ...
    images: storyImages([
      [
        '/native-build-assets/google-play-console-releases-button.webp',
        'Google Play Console releases screen representing a blocked release',
      ],
      [
        '/native-build-assets/google-play-console-select-apk-file.webp',
        'Google Play Console artifact upload screen representing repeated Android submissions',
      ],
      [
        '/native-build-assets/google-play-console-save-and-publish.webp',
  ...
  },
  {
    ...
    images: storyImages([
      [
        '/native-build-assets/google-play-console-confirm-publication.webp',
        'Google Play Console confirmation screen representing a delayed hotfix publication',
      ],
      ['/app_demo.webp', 'Mobile app interface representing a production hotfix waiting for store review'],
    ]),
  },
]
