...
locale: de
description: Vollständiger Leitfaden zum Bestehen der App Store-Prüfung mit In-App-Käufen und Abonnements, einschließlich häufiger Ablehnungsgründe und Bewährte Methoden.
sidebar:
  order: 10
---
...
## Bewährte Methoden für Native Purchases Plugin
...
- [Bewährte Methoden für Abonnements](https://developer.apple.com/app-store/subscriptions/)
