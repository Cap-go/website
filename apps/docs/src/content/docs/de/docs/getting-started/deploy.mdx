...
description: "Erfahren Sie, wie Sie ein Live-Update für Ihre App mit der Live-Updates-Funktion von Capgo bereitstellen, die Echtzeit-UI- und Logik-Updates ohne erneute Einreichung im App Store ermöglicht."
sidebar:
  order: 4
locale: de
---
