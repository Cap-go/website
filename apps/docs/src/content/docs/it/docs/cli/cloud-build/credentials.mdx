...
- [Guida ai Certificati iOS (Capgo)](https://capgo.app/cloud/native-builds/certificates/ios/) - Tutorial dettagliato con screenshot
...
- [Guida ai Certificati Android (Capgo)](https://capgo.app/cloud/native-builds/certificates/android/) - Tutorial dettagliato con screenshot
...
- ✅ Utilizzate SOLO durante il processo di build attivo
- ✅ Automaticamente eliminate dopo il completamento della build
- ✅ Conservazione massima: 24 ore (anche se la build fallisce)
- ✅ Le app vengono inviate direttamente all'App Store/Play Store - NON conserviamo NULLA
- ✅ Trasmesse in modo sicuro tramite HTTPS
</Aside>
