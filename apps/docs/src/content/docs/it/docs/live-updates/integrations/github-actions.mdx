...
**Testing con i canali**: Dopo aver distribuito su un canale PR o development, puoi testare l'aggiornamento nella tua app configurandola per usare quel canale specifico. Scopri di più sulla [configurazione dei canali nella tua app](/docs/live-updates/channels/#configuring-the-channel-in-your-app).

</Aside>

### Pulizia dei canali di funzionalità
...
1. Vai su **Settings** → **Environments** nel tuo repository
