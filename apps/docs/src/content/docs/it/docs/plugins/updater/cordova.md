...
Sappiamo che possiamo farlo ma per questo, dobbiamo leggere tutto il codice della codebase di Cordova come abbiamo fatto per Capacitor, per capire come farlo funzionare con tutte le funzionalità di Capgo.

La versione Android è più facile da fare poiché entrambi usano Java, ma iOS necessita di una riscrittura completa perché Swift non è ancora ben supportato in Cordova
