...
<Aside type="note">
Kembali ke build sebelumnya hanya mempengaruhi channel yang dipilih. Jika Anda memiliki beberapa channel (misalnya Production, Staging, dll), Anda perlu mengulangi proses pengembalian untuk setiap channel yang terdampak.
</Aside>
...
1. Navigasi ke channel di Capgo Dashboard
