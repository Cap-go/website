...
<Aside type="caution" title="Channel tidak memberikan kerahasiaan">
Channel mengontrol kelayakan pembaruan, bukan kerahasiaan bundle. Bahkan jika sebuah channel bersifat privat atau self-assignment dinonaktifkan, bundle tanpa enkripsi yang diunggah ke Capgo tetap harus diperlakukan sebagai aset publik yang dikirim ke klien. Enkripsi melindungi jalur distribusi dan keaslian pembaruan, tetapi bundle yang dikirim masih dapat direkayasa balik dari aplikasi terdistribusi dengan usaha yang cukup karena kunci publik merupakan bagian dari klien. Lihat [enkripsi Live Updates](/docs/live-updates/encryption/) untuk detailnya.
</Aside>
