...
sidebar:
  order: 4
---
import { Steps, LinkCard, Tabs, TabItem, Aside } from '@astrojs/starlight/components';
...
<Aside type="tip">
Capgo uploads the generated web build folder. HTML, CSS, JavaScript, assets, and pure-JavaScript package changes can go OTA once they are bundled there. Changes to `capacitor.config.ts`, native plugin configuration, native packages, or iOS/Android project files require a native app release.
</Aside>
