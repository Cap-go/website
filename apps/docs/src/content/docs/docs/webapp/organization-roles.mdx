...
| **Admin** | `org_admin` | Full administration — manage members, apps, channels. Cannot delete the org, update billing, or transfer apps. |
...
| `org.update_user_roles` | Change member roles (including Super Admin) | ✅ | ✅ | ❌ | ❌ |
