...
For preview CI, an app-scoped **App Preview** key can delete channels in its selected apps but cannot delete the associated bundle. See [API Keys](/docs/webapp/api-keys/#use-an-app-preview-key-for-preview-workflows) for the least-privilege setup.
