...
| iOS | Android |
| :---: | :---: |
| <img src="/plugins/demo/capacitor-calendar/ios-demo.webp" alt="iOS demo of native calendar event creation" width="280" /> | <img src="/plugins/demo/capacitor-calendar/android-demo.webp" alt="Android demo of native calendar event creation" width="280" /> |
