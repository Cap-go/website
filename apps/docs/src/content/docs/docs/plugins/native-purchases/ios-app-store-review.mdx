...
![App Store listing metadata with policy and support links](/app-store-assets/checklist/policy-links.png)
...
![Paywall with restore purchases and legal links](/app-store-assets/checklist/paywall-links.png)
...
![Permission copy that is too vague for review](/app-store-assets/checklist/rejected-permissions.png)

![Permission copy with clearer explanations](/app-store-assets/checklist/accepted-permissions.png)
