...
- `connectionChanged` fires when the car host connects or disconnects.
- `carAction` fires when a car row is selected.
- `messageReceived` fires for application-defined bridge messages.
