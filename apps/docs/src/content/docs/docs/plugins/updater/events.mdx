...
Please see the [placing notifyAppReady call correctly](/docs/plugins/updater/notify-app-ready/#placing-notifyappready-call-correctly) docs for more information.
</Aside>
