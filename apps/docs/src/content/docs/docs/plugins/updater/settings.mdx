...
<Aside type="note">
Need EU data residency for Capgo Cloud? Set `updateUrl`, `statsUrl`, and `channelUrl` together to the EU host shown in [Data Location](/docs/live-updates/data-location/).
</Aside>
