...
| **major** | Target major above native baseline | Same major, including minor and patch changes | Prevent breaking changes from reaching old native |
| **minor** | Different major or minor than native baseline | Same major.minor line, including patch and prerelease changes | Stricter control within major |
| **patch** | Different major, minor, or patch than native baseline | Same MAJOR.MINOR.PATCH core, including prerelease/build metadata changes | Very strict; same-core updates only |
