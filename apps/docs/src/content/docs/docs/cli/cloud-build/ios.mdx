...
![Start Apple Developer enrollment](/app-store-assets/apple-account/start-enrollment.png)

![Continue Apple enrollment on the web](/app-store-assets/apple-account/web-enrollment.png)

![Select the correct Apple Developer entity type](/app-store-assets/apple-account/entity-type.png)

![App Store Connect after enrollment](/app-store-assets/apple-account/app-store-connect-home.png)
