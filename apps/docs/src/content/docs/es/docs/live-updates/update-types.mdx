...
description: >-
  Una referencia completa de todos los tipos de actualización OTA que
  proporciona Capgo: momento de aplicación, condiciones de retraso, bloqueo de
  versiones y métodos de entrega.
sidebar:
  order: 2
locale: es
---
