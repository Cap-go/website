...
<Aside type="caution" title="Modelo de Activo Público">
Los bundles sin cifrar que se suben a Capgo deben tratarse como artefactos públicos de entrega. Los canales determinan a qué dispositivos se les ofrece una actualización, pero la privacidad del canal no hace confidencial el bundle subyacente. El cifrado añade protección en almacenamiento y tránsito y evita que terceros generen actualizaciones cifradas válidas, pero no hace imposible inspeccionar los activos web distribuidos porque la app contiene la clave pública necesaria para descifrarlos. Consulta [el cifrado de extremo a extremo](/docs/live-updates/encryption/) para ver el modelo de amenazas exacto.
</Aside>
...
<CardGrid stagger>
  <a href="/docs/live-updates/update-types/">
    <Card title="Tipos de Actualización" icon="open-book">
      Referencia de todos los tipos de actualización OTA: tiempo de aplicación, condiciones de retraso, bloqueo de versiones y entrega.
    </Card>
  </a>
