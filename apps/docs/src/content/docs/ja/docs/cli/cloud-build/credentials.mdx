...
- [iOS証明書ガイド（Capawesome）](https://capgo.app/cloud/native-builds/certificates/ios/) - スクリーンショット付きの詳細チュートリアル
...
- [Android証明書ガイド（Capawesome）](https://capgo.app/cloud/native-builds/certificates/android/) - スクリーンショット付きの詳細チュートリアル
