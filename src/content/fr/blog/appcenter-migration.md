...
Vous avez migré d'App Center vers Capgo, en utilisant les mises à jour en direct. Ce n'est que le début de ce que vous pouvez utiliser Capgo pour explorer le reste du service incluant Channel (environnements multiples) et remplacer l'intégration Cloud CLI, utilisez Capgo dans votre CI/ Plateforme de CD de choix (telle que GitHub Action, GitLab, Jenkins, etc.)
