...
Les logiciels open source sont généralement gratuits à télécharger et à utiliser, et ils sont souvent disponibles dans plusieurs langues. Cela les rend plus accessibles aux personnes du monde entier, quels que soient leurs revenus ou leurs origines.
...
En mettant à disposition des logiciels avec ce type de licence, les développeurs s'assurent que d'autres ont accès à leur code source, ce qui leur permet d'apporter des améliorations et des adaptations qui profitent à la communauté. De plus, ce concept de « copyleft » garantit que chacun peut partager les mêmes libertés de manière collaborative. quand on travaille avec des logiciels libres

**Licence publique Mozilla**

La [Licence publique Mozilla](https://wwwmozillaorg/en-US/MPL/20/), ou MPL, provient de la [Fondation Mozilla](https://foundationmozillaorg/en/) et est également considérée comme une licence à copyleft faible. La différence avec cette licence (par rapport à la licence publique Eclipse) est qu'elle est copyleft basé sur des fichiers, ce qui signifie que le code peut être combiné avec du code open source ou propriétaire
