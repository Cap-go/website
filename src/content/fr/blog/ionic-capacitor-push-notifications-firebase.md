...
head_image_alt: Notifications push de condensateur ionique avec Firebase
tag: tutorial
published: true
locale: fr
next_blog: ''
...
![capacitor-xcode-capability](/capacitor-xcode-capabilitywebp)
...
Mettre à jour le routage dans **app/app-routingmodulets** pour inclure la nouvelle page avec un identifiant dynamique :
