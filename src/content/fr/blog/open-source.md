...
Dans cet article, j'expliquerai ce qu'est un logiciel Open Source et expliquerai en quoi il diffère des autres types de logiciels. Je discuterai également des avantages des logiciels Open Source et de la façon de commencer à contribuer à des projets.
...
Le nom original devait être "logiciel libre", mais il y avait beaucoup de confusion sur ce que "gratuit" signifiait réellement. Afin de clarifier le problème, Peterson a proposé de changer le nom en "logiciel open source".
...
N'oubliez pas que contribuer à l'open source n'est pas seulement une question de codeVous pouvez également contribuer à la documentation, à la conception, aux tests et à la gestion de projet. La clé est de trouver un moyen de contribuer qui correspond à vos compétences et intérêts.

## Tirez parti de la technologie open source derrière Capgo

Comme vous le savez, les technologies open source présentent de multiples avantages. Elles sont disponibles à une partie du prix des logiciels propriétaires. Elles sont également flexibles et plus sécurisées grâce aux révisions fréquentes du code par la communauté open source.
