...
| Temps de réponse API | 434ms en moyenne dans le monde [\[1\]](https://capgo.app/) | Interactions fluides et efficaces |
...
-   **Performance** : 434ms en moyenne pour le temps de réponse de l'API dans le monde [\[1\]](https://capgo.app/)
