...
Capgo riporta un tasso di successo globale dell'82% per gli aggiornamenti, con un tempo di risposta API medio di 434ms in tutto il mondo [\[1\]](https://capgo.app/).
