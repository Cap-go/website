...
[Capgo](https://capgo.app/) has shared some impressive stats: **95% of users updated within 24 hours**, an **82% global success rate**, a **57ms average API response time**, and **5MB bundles delivered in just 114ms** [\[1\]](https://capgo.app/).
...
Capacitor CI/CD plugins are now designed to meet the needs of enterprise users. For instance, Capgo's implementation delivers a 5MB bundle in just 114ms, with an average global API response time of 57ms [\[1\]](https://capgo.app/).
