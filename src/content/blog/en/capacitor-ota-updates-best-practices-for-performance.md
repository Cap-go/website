...
updated_at: 2025-03-18T13:14:01.788Z
...
-   **[Secure Updates](https://capgo.app/es/docs/plugin/cloud-mode/hybrid-update/)**: Protect files with encryption, checksums, and code signing to ensure integrity.
...
-   **[Bundle Size Management](https://capgo.app/es/docs/webapp/bundles/)**  
...
| **Update Scheduling** | [Process updates](https://capgo.app/it/docs/plugin/cloud-mode/hybrid-update) in the background, Wi-Fi only | Reduces user disruption |
