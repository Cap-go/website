...
この機能は、従来のレビューサイクルの遅延なしに、アプリを最新の状態に保つ更新プロセスを合理化します。Capgoは、既存のセットアップに柔軟に対応できるCapacitor 8の両方に対応しています。
...
これらの機能は、[バージョン更新](https://capgo.app/docs/live-updates/update-behavior/) を効果的に管理するための強力なフレームワークを支えています。
