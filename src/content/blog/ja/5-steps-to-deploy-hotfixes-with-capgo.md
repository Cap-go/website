...
> "5000人以上のユーザーベースに対して[Capgo OTAアップデート](https://console.capgo.app/resend_email)を本番環境で展開しました。非常にスムーズな運用が見られ、OTAが@Capgoに展開されてから数分以内にほぼすべてのユーザーが最新の状態になっています" [\[1\]](https://capgo.app/)。
