...
> "私たちは5000人以上のユーザーベースに対して本番環境で[Capgo OTAアップデート](https://web.capgo.app/resend_email)をロールアウトしました。OTAが@Capgoにデプロイされてから数分以内にほぼすべてのユーザーが最新になり、非常にスムーズな運用を実現しています。" - colenso [\[1\]](https://capgo.app/)
