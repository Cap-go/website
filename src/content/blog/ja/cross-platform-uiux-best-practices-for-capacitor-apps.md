...
> "私たちは、+5000のユーザーベースに向けて[Capgo OTAアップデート](https://console.capgo.app/resend_email)を本番環境で展開しました。OTAが@Capgoにデプロイされてから、ほぼすべてのユーザーが数分以内に最新の状態になっています。" – colenso [\[1\]](https://capgo.app/)
