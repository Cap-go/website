...
> "5,000人のユーザーベースに対して本番環境で[Capgo OTAアップデート](https://console.capgo.app/resend_email)を展開しました。非常にスムーズな運用が実現し、OTAがデプロイされてから数分以内にほぼすべてのユーザーが最新の状態になっています" – colenso, @colenso [\[1\]](https://capgo.app/)
