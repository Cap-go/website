...
> "우리는 5,000명의 사용자 기반에 대해 [Capgo OTA 업데이트](https://console.capgo.app/resend_email)를 실제 환경에 배포했습니다. OTA가 @Capgo에 배포된 후 몇 분 내에 거의 모든 사용자가 최신 상태가 되는 매우 원활한 운영을 확인했습니다." – colenso, @colenso [\[1\]](https://capgo.app/)
