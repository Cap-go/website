...
このガイドでは、Capacitor Social Login プラグインを使用して Google サインインと Supabase 認証を統合する方法を説明します。このセットアップにより、バックエンド認証に Supabase Auth を活用しながら、モバイル プラットフォームでネイティブな Google サインインを使用できます。
