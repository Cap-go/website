...
description: >-
  Learn how to set up Google Sign-In with Supabase Authentication on Android
  using the Capacitor Social Login plugin.
sidebar:
  order: 2
locale: ja
---
...
このガイドは、Android で Supabase 認証との Google サインインを統合するのに役立ちます。すでに以下を完了していることを前提としています:
 -  [Google Login Android セットアップ](/docs/plugins/social-login/google/android/)
