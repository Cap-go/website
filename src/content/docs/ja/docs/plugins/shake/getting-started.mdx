...
description: >-
  Learn how to install and configure the Capacitor Shake plugin to detect shake
  gestures and create interactive experiences in your app.
sidebar:
  order: 2
locale: ja
---
...
1. **デバッグメニュー**: デバイスが揺れたときに開発者オプションを表示
2. **フィードバック**: フィードバックフォームまたはバグレポートをトリガー
3. **更新**: アプリデータを更新またはキャッシュをクリア
4. **ゲーム**: ゲーム制御メカニズムとしてシェイクを使用
5. **元に戻す**: シェイク-元に戻す機能を実装
