...
description: >-
  Learn how to install and use the Ricoh 360° Camera plugin to control Ricoh
  Theta cameras in your Capacitor app.
sidebar:
  order: 2
locale: ja
---
...
このプラグインはRicoh Thetaシリーズカメラをサポートしています:
- Ricoh Theta V
- Ricoh Theta Z1
- Ricoh Theta SC2
- Ricoh Theta X
...
- プラグインを初期化してからカメラに接続してください
- デバイスがカメラのWiFiネットワークに接続していることを確認してください
- エラーを適切に処理してください。特に接続エラーについて
- 完了したらプレビューを停止して切断し、バッテリーを節約してください
- 長時間の録画セッション前にカメラのバッテリーレベルを確認してください
- 実際のRicoh Thetaハードウェアでテストしてください
- ストレージの制約に基づいて適切なビデオ品質を使用してください
...
- WiFi SSIDとパスワードが正しいことを確認してください
- 他のアプリがカメラに接続していないことを確認してください
- 接続に失敗した場合、カメラのWiFi設定をリセットしてください

### プレビューが表示されない

- HTMLコンテナ要素が存在することを確認してください
- カメラの権限が付与されていることを確認してください
- 接続に成功した後、プレビューを開始していることを確認してください

### キャプチャの失敗

- 利用可能なストレージスペースを確認してください
- カメラのバッテリーレベルが十分なことを確認してください
- カメラがスリープモードでないことを確認してください
