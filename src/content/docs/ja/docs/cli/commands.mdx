...
`[appId]` アプリIDのフォーマット`comtestapp`は[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています
...
`[appId]` はアプリID、フォーマットは[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています
...
`[appId]` はアプリIDです。フォーマットについては[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています
...
`[channelId]` 新しいチャンネルの名前 `[appId]` アプリID フォーマット`comtestapp`については[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています

### **削除**

`npx @capgo/cli channel delete [channelId] [appId]`

`[channelId]` 削除したいチャンネルの名前 `[appId]` アプリID フォーマット`comtestapp`については[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています

### **一覧**

`npx @capgo/cli channel list [appId]`

`[appId]` アプリID フォーマット`comtestapp`については[こちら](https://capacitorjs.com/docs/cli/commands/init/)で説明されています
