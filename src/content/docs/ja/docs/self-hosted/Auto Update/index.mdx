...
このプロジェクトを独自に利用される場合は、[こちら](https://githubcom/sponsors/riderx/)から私の活動を支援していただけると幸いです。
...
もしcapgoのサービスがあなたに合わない場合は、[こちら](https://githubcom/sponsors/riderx/)からあなたの条件でブートストラップされた開発者を支援してください。
...
> 🚧 AndroidではHTTPリクエストが許可されていません。テスト目的の場合は[許可してください](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted/)
