---
title: 機能
description: "コアアップデートシステムから高度なデプロイメント制御、分析、チームコラボレーション機能まで、Capgo Live Updateのすべての機能の完全なリファレンス。"
sidebar:
  order: 2
locale: ja
---
...
このページでは、Capgo Live Updatesで利用可能なすべての機能の包括的な概要を提供します。各機能には簡単な説明と詳細なドキュメントへのリンクが含まれています。
