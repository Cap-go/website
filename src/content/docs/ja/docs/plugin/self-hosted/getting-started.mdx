...
この作業が役立つと思われる場合は、[Githubスポンサー](https://githubcom/sponsors/riderx)になって私の活動をサポートすることをご検討ください
...
Capgoが合わない場合は、ご自身で価格を決めて、[ブートストラップ開発者](https://githubcom/sponsors/riderx)を支援してください
