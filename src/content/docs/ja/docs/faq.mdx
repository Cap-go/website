...
ダッシュボードでいつでもプランをアップグレードまたはダウングレードできます：[https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
...
ダッシュボードでいつでもサブスクリプションをキャンセルできます：[https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)

### 1年分を前払いできますか？

ダッシュボードでいつでも可能です：[https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
