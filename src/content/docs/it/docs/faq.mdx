...
Puoi aggiornare o declassare il tuo piano in qualsiasi momento nel tuo dashboard: [https://webcapgo.app/dashboard/settings/plans](https://webcapgo.app/dashboard/settings/plans/)
...
Puoi cancellare il tuo abbonamento in qualsiasi momento nel tuo dashboard: [https://webcapgo.app/dashboard/settings/plans](https://webcapgo.app/dashboard/settings/plans/)

### Posso pagare per un anno in anticipo?

Sì puoi farlo in qualsiasi momento nel tuo dashboard: [https://webcapgo.app/dashboard/settings/plans](https://webcapgo.app/dashboard/settings/plans/)
