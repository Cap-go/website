...
<Aside type="caution" title="I canali non forniscono riservatezza">
I canali controllano l'idoneità agli aggiornamenti, non la segretezza del bundle. Anche se un canale è privato o l'auto-assegnazione è disabilitata, qualsiasi bundle non crittografato caricato su Capgo deve comunque essere trattato come una risorsa pubblica consegnata ai client. La crittografia protegge il percorso di distribuzione e l'autenticità degli aggiornamenti, ma i bundle distribuiti possono comunque essere sottoposti a reverse engineering dall'app distribuita con sufficiente impegno perché la chiave pubblica fa parte del client. Vedi [la crittografia dei Live Update](/docs/live-updates/encryption/) per i dettagli.
</Aside>
