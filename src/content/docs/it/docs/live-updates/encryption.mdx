...
**Cosa protegge davvero la crittografia**: A differenza dei sistemi OTA che si limitano a firmare gli aggiornamenti, Capgo crittografa il bundle caricato prima dell'archiviazione e della distribuzione. Questo protegge il contenuto del bundle da accessi casuali durante transito e archiviazione e garantisce che solo chi possiede la tua chiave privata possa produrre un aggiornamento crittografato valido. **Non** rende impossibile fare reverse engineering delle risorse web distribuite: la chiave pubblica che il client usa per decrittografare gli aggiornamenti è distribuita dentro l'app, quindi un attaccante determinato può comunque estrarla e ispezionare il contenuto del bundle con sufficiente impegno.

<Aside type="note" title="Quando hai bisogno della crittografia">
Se carichi un bundle senza crittografia, trattalo come una risorsa pubblica. I canali privati limitano quali dispositivi ricevono un aggiornamento, ma non rendono riservato il bundle caricato. La crittografia è utile quando desideri una protezione migliore durante archiviazione e transito e quando vuoi che solo i titolari della chiave privata possano pubblicare aggiornamenti crittografati validi. Non garantisce che JavaScript, HTML o CSS distribuiti non possano mai essere ispezionati.
</Aside>

<Aside type="caution" title="Modello di minaccia">
La crittografia di Capgo protegge dalla divulgazione del bundle da parte di Capgo, provider di storage, CDN o chiunque veda solo l'artefatto crittografato di distribuzione. Impedisce inoltre a terzi di generare aggiornamenti crittografati validi senza la tua chiave privata. Poiché la chiave pubblica è incorporata nell'app distribuita per permettere al client di decrittografare gli aggiornamenti, qualcuno che possiede il binario della tua app e ha sufficiente motivazione può comunque recuperare il materiale di chiave necessario per ispezionare il bundle.
</Aside>
...
|---------|-------|-------------------|
| **Contenuto del bundle** | Crittografato in archiviazione e transito; ancora ispezionabile da un reverse engineer determinato con il binario dell'app | Leggibile pubblicamente |
| **Metodo di sicurezza** | Vera crittografia end-to-end | Solo firma del codice |
| **Livello di privacy** | Forte protezione in distribuzione e archiviazione; non anti-reverse-engineering | La piattaforma può accedere al tuo codice |
...
- **La crittografia di Capgo** protegge il bundle mentre viene archiviato e distribuito e rende molto più difficile falsificare aggiornamenti crittografati perché un attaccante avrebbe bisogno della tua chiave privata
- **Il reverse engineering resta possibile** dopo la distribuzione dell'app, perché il client contiene la chiave pubblica necessaria per decrittografare e caricare l'aggiornamento
