...
description: >-
  Un riferimento completo di tutti i tipi di aggiornamento OTA forniti da Capgo:
  tempistiche di applicazione, condizioni di ritardo, blocco delle versioni e
  metodi di consegna.
sidebar:
  order: 2
locale: it
