...
1. [Crea un account Capgo](https://capgo.app/register)
2. Segui la nostra [guida rapida](/getting-started/quickstart/)
3. Configura l'[integrazione CI/CD](/getting-started/cicd-integration/)
4. Configura gli [aggiornamenti live](/live-updates/)
