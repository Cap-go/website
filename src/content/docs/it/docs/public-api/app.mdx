...
title: Apps
description: >-
  Documentazione dettagliata per l'endpoint Apps, che fornisce informazioni
  complete sulla gestione e l'interazione con le applicazioni Capacitor
  attraverso la piattaforma Capgo.
sidebar:
  order: 7
locale: it
---
...
- **Usage Statistiche**: Metriche su installazioni e aggiornamenti
