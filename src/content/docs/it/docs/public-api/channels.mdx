...
title: Canali
description: >-
  Guida alla gestione dei canali di aggiornamento delle app in Capgo, che copre
  il controllo delle versioni, il targeting della piattaforma e le politiche di
  aggiornamento.
sidebar:
  order: 6
locale: it
