---
title: "Bundles"
description: "Guida dettagliata per gestire i Capgo Bundles, coprendo elenco, eliminazione, versioning e ottimizzazione dello storage per i pacchetti di aggiornamento delle app."
sidebar:
  order: 8
---
