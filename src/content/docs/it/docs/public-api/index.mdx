...
description: "Esplora l'API pubblica di Capgo per gestire risorse come organizzazioni, dispositivi, canali e bundle utilizzando metodi HTTP RESTful e autenticazione."
sidebar:
  order: 1
---
