...
`[channelId]` il nome del tuo nuovo canale `[appId]` il tuo ID app il formato `comtestapp` è spiegato [qui](https://capacitorjscom/docs/cli/commands/init/)

### **Delete**

`npx @capgo/cli channel delete [channelId] [appId]`

`[channelId]` il nome del canale che vuoi eliminare `[appId]` il tuo ID app il formato `comtestapp` è spiegato [qui](https://capacitorjscom/docs/cli/commands/init/)
