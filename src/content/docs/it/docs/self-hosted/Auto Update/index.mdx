...
Se usi questo lavoro per conto tuo, non posso che suggerirti di supportare il mio lavoro attraverso [questo](https://githubcom/sponsors/riderx/)
...
> 🚧 In android non è consentito richiedere HTTP, per scopi di test [consentilo](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted/)
