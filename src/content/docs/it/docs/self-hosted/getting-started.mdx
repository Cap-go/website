...
Se utilizzi questo lavoro in autonomia, non posso che suggerirti di supportare il mio lavoro attraverso [Github support](https://githubcom/sponsors/riderx/)
...
Se l'offerta Capgo non fa per te, allora stabilisci il tuo prezzo e sostieni un Maker bootstrapped [QUI](https://githubcom/sponsors/riderx/) alle tue condizioni
