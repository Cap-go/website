...
Puoi anche disabilitarle completamente, con una stringa vuota. Tieni presente che le statistiche sono rese private e mi aiutano a capire come le persone utilizzano il plugin, per risolvere problemi e migliorarlo
