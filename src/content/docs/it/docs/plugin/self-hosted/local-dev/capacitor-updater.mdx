...
description: Come utilizzare Capacitor Updater con Capgo self-hosted
sidebar:
  order: 4
locale: it
---
...
1. [Capgo clonato](https://githubcom/Cap-go/capgo)
...
Questo può essere ottenuto modificando [AndroidManifestxml](https://githubcom/Cap-go/capacitor-updater/blob/main/android/src/main/AndroidManifestxml) e aggiungendo `android:usesCleartextTraffic="true"` nel tag `application`.
...
Questo codice è qui [per uno scopo preciso](https://githubcom/Cap-go/capacitor-updater/issues/37#issuecomment-1684916354)
:::
