...
| `/src/content/plugins/en/` | File tutorial inglese |
...
7. ### Crea File Tutorial
   ...
   Crea `/src/content/plugins/en/your-plugin-name.md`:
...
- [ ] Creato tutorial in `/src/content/plugins/en/`
...
2. Rivedi le traduzioni generate in:
   - `/src/content/plugins/de/` (Tedesco)
   - `/src/content/plugins/es/` (Spagnolo)
   - `/src/content/plugins/fr/` (Francese)
   - `/src/content/plugins/it/` (Italiano)
   - `/src/content/plugins/ja/` (Giapponese)
   - `/src/content/plugins/ko/` (Coreano)
   - `/src/content/plugins/id/` (Indonesiano)
