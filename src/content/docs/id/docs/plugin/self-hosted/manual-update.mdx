...
:::note
Jika ini terlihat seperti banyak pekerjaan, pertimbangkan untuk mencoba [uji coba Capgo](https://capgo.app/register/) yang akan menangani semua ini untuk Anda
:::
