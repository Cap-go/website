---
title: API Statistik
description: Cara menggunakan plugin pembaruan otomatis dalam mode self-hosting
sidebar:
  order: 8
locale: id
---
...
Mulai dari versi 130 sistem pembaruan dapat mengirim statistik!
...
interface AppInfosStats {
	...
	"app_id": "*******", // pengidentifikasi aplikasi di toko
	"device_id": "*******", // id unik per pemasangan aplikasi
