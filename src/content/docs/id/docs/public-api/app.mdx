...
title: Apps
description: >-
  Dokumentasi terperinci untuk endpoint Apps, memberikan wawasan komprehensif
  tentang pengelolaan dan interaksi dengan aplikasi Capacitor melalui platform
  Capgo.
sidebar:
  order: 7
locale: id
