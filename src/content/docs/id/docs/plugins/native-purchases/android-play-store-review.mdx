...
Mendapatkan persetujuan aplikasi Android Anda di Google Play memerlukan kepatuhan terhadap kebijakan Google, terutama untuk aplikasi dengan pembelian dalam aplikasi dan langganan. Panduan ini mencakup semua yang Anda butuhkan untuk lulus review dengan sukses.

## Persyaratan Penagihan Google Play

### Sistem Penagihan Wajib

Untuk barang digital dan layanan, Anda **harus** menggunakan sistem penagihan Google Play:

**Barang Digital (Harus Menggunakan Play Billing):**
- Langganan ke fitur premium
- Mata uang dalam aplikasi atau kredit
- Konten digital (ebook, musik, video)
- Peningkatan permainan dan power-up
- Pembukaan aplikasi dan tingkat premium

**Barang Fisik (Tidak Dapat Menggunakan Play Billing):**
- Barang dagangan fisik
- Layanan dunia nyata
- Sumbangan satu kali untuk organisasi nirlaba

:::caution Persyaratan 2025
Aplikasi baru harus menggunakan API `monetization.subscriptions` untuk menangani katalog langganan. API penagihan warisan sudah usang.
:::
