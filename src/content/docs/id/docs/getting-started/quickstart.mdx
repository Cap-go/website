...
<Aside type="caution" title="Kerahasiaan Bundle">
Perlakukan setiap bundle yang diunggah ke Capgo sebagai aset web publik kecuali Anda mengaktifkan enkripsi Capgo. Channel privat mengontrol perangkat mana yang memenuhi syarat untuk menerima pembaruan, tetapi tidak membuat bundle yang diunggah menjadi rahasia. Enkripsi melindungi jalur distribusi dan mencegah pihak ketiga menghasilkan pembaruan terenkripsi yang valid, tetapi aset web yang dikirim tetap dapat direkayasa balik dari aplikasi dengan usaha yang cukup karena kunci publik didistribusikan di dalam biner. Lihat [enkripsi Live Updates](/docs/live-updates/encryption/).
</Aside>
