...
<CardGrid>
  ...
  <a href="/docs/live-updates/update-types/"><Card title="Jenis Update" icon="book">
    Referensi semua jenis update OTA: waktu penerapan, kondisi penundaan, pemblokiran versi, dan pengiriman
  </Card></a>
