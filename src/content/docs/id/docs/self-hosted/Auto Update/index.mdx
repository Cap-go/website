...
Jika Anda menggunakan karya ini untuk keperluan sendiri, saya sangat menyarankan untuk mendukung pekerjaan saya melalui [ini](https://githubcom/sponsors/riderx/)
...
> 🚧 Di android tidak diizinkan untuk request ke HTTP, untuk keperluan testing [izinkan ini](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted/)
