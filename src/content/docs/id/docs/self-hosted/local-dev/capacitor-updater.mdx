...
Ini dapat dicapai dengan memodifikasi [AndroidManifestxml](https://githubcom/Cap-go/capacitor-updater/blob/main/android/src/main/AndroidManifestxml/) dan menambahkan `android:usesCleartextTraffic="true"` dalam tag `application`
Contoh lengkap perubahan ini dapat dilihat [di sini](https://gistgithubcom/WcaleNieWolny/061a015acdebe35eaf3afd7030797701/)

Karena secara default, Android tidak mengizinkan `http` capgo telah mengimplementasikan pemeriksaan untuk http [di sini](https://githubcom/Cap-go/capgo/blob/4cce6c0707d745faa2afbab643e636bad927c602/supabase/functions/updates/indexts/#L396)
...
Kode ini ada [dengan sengaja](https://githubcom/Cap-go/capacitor-updater/issues/37/#issuecomment-1684916354)
:::
