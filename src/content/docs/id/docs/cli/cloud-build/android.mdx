...
- [Panduan Sertifikat Android](https://capgo.app/cloud/native-builds/certificates/android/)
...
<Aside type="tip">
Untuk instruksi detail dengan screenshot, lihat [Panduan Sertifikat Android](https://capgo.app/cloud/native-builds/certificates/android/).
</Aside>
