...
<Aside type="tip" title="Direkomendasikan: Gunakan Delta Updates dengan Direct Update">
Saat menggunakan `directUpdate`, kami **sangat merekomendasikan** untuk mengaktifkan [Delta Updates](/docs/live-updates/differentials/) untuk meminimalkan waktu unduh dan meningkatkan pengalaman pengguna. Delta Updates hanya mengunduh file yang berubah alih-alih seluruh bundle, yang sangat penting ketika pembaruan diterapkan segera saat pengguna aktif menggunakan aplikasi Anda.

**Mengapa ini penting untuk Direct Updates:**
- **Pembaruan lebih cepat**: Unduhan yang lebih kecil berarti pembaruan selesai dengan cepat, mengurangi waktu pengguna melihat layar pemuatan
- **Pengalaman seluler yang lebih baik**: Pengguna di jaringan seluler atau koneksi yang lebih lambat tidak akan menghadapi waktu tunggu yang lama
- **Penggunaan bandwidth yang lebih rendah**: Hanya file yang berubah yang diunduh, menghemat data untuk Anda dan pengguna Anda

Untuk mengaktifkan Delta Updates, cukup gunakan flag `--partial` saat mengunggah bundle:
```shell
npx @capgo/cli@latest bundle upload --partial
```

Pelajari lebih lanjut di [dokumentasi Delta Updates](/docs/live-updates/differentials/).
</Aside>
