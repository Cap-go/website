...
<Aside type="caution" title="Model Aset Publik">
Bundle tanpa enkripsi yang diunggah ke Capgo harus diperlakukan sebagai artefak distribusi publik. Channel menentukan perangkat mana yang ditawari pembaruan, tetapi privasi channel tidak membuat bundle dasarnya menjadi rahasia. Enkripsi menambah perlindungan saat penyimpanan dan transit serta mencegah pihak ketiga menghasilkan pembaruan terenkripsi yang valid, tetapi tidak membuat aset web yang dikirim mustahil untuk diperiksa karena aplikasi berisi kunci publik yang dibutuhkan untuk mendekripsinya. Lihat [enkripsi end-to-end](/docs/live-updates/encryption/) untuk model ancaman yang tepat.
</Aside>
...
<CardGrid stagger>
  <a href="/docs/live-updates/update-types/">
    <Card title="Jenis Pembaruan" icon="open-book">
      Referensi semua jenis pembaruan OTA: waktu penerapan, kondisi penundaan, pemblokiran versi, dan pengiriman.
    </Card>
  </a>
