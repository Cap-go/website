...
2. Dalam kode aplikasi Anda, panggil `CapacitorUpdaternotifyAppReady()` setelah aplikasi Anda selesai diinisialisasi. Ini memberi tahu SDK Capgo bahwa aplikasi Anda siap menerima pembaruan
