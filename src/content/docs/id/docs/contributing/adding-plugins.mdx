...
| `/src/content/plugins/en/` | File tutorial bahasa Inggris |
...
7. ### Buat File Tutorial
   ...
   Buat `/src/content/plugins/en/your-plugin-name.md`:
...
- [ ] Membuat tutorial di `/src/content/plugins/en/`
...
2. Review terjemahan yang dihasilkan di:
   - `/src/content/plugins/de/` (Jerman)
   - `/src/content/plugins/es/` (Spanyol)
   - `/src/content/plugins/fr/` (Prancis)
   - `/src/content/plugins/it/` (Italia)
   - `/src/content/plugins/ja/` (Jepang)
   - `/src/content/plugins/ko/` (Korea)
   - `/src/content/plugins/id/` (Indonesia)
