---
title: Commencer
description: Learn how to integrate YouTube video playback in your Capacitor Application.
sidebar: 
  order: 2
---
...
Initialiser a YouTube player instance.
...
1. **Initialiser once**
   Créer player instance once and reuse it:
   ```typescript
...
4. **Respect Utilisateur preferences**
   ```typescript
...
**Player not loading:**
- Vérifier video ID is valid
- Verify internet connection
- Ensure YouTube embedding is allowed for the video

**Events not firing:**
- Make sure listeners are added after Initialisation
- Vérifier player is ready before adding listeners

**Quality issues:**
- Vérifier Disponible quality levels first
