---
title: "Events"
description: "All events you can listen to in the Capacitor Updater plugin for monitoring Mise à jour status and progress"
sidebar: 
  order: 9
---
...
<Aside>
This event fires multiple times during Télécharger to Signaler progress.
</Aside>
...
<Aside type="tip">
Major Mises à jour typically require Utilisateur confirmation or Application Store Mises à jour. Use this event to notify Utilisateurs appropriately.
</Aside>
...
## Exemple: Terminé Mise à jour Flow
...
Please see the [placing notifyAppReady call correctly](/docs/plugins/updater/auto-Mise à jour#placing-notifyappready-call-correctly) docs for more Information.
</Aside>
