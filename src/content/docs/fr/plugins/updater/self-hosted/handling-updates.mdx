---
title: "Mise à jour API Endpoint"
description: "How to Construction your Mise à jour server API endpoint to respond to Capgo plugin requests with proper Bundle Information and checksums"
sidebar: 
  order: 6
---
...
For Chiffré Bundles, see the [Chiffré Bundles Documentation](/docs/plugin/self-hosted/Chiffré-Bundles/) which explains the Terminé Chiffrement workflow.
