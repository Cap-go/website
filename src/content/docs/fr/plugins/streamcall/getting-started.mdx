...
locale: fr
title: Commencer
description: Learn how to Installer and integrate Stream Video SDK for professional video calling in your Capacitor Application.
sidebar: 
  order: 2
---
...
You'll need a Stream Compte and API credentials. Sign up at [Stream](https://getstream.io/) if you don't have one.
...
Initialiser the Stream Video SDK.
...
Activer or Désactiver the camera.
...
Activer or Désactiver the microphone.
...
Switch between front and Retour camera.
...
Activer or Désactiver speakerphone.
...
Send a call invitation to a Utilisateur.
...
- Initialiser the SDK early in your Application lifecycle
- Handle permission requests before starting calls
- Implement proper Erreur handling for network issues
- Clean up listeners when components unmount
- Test on actual Appareils (not just emulators)
...
The plugin supports multiple languages for Natif UI elements. Configure in your platform-specific Paramètres.
