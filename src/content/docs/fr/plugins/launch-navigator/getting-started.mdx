...
locale: fr
title: Commencer
description: Learn how to Installer and use the Launch Navigator plugin to integrate with Natif navigation apps on iOS and Android.
sidebar: 
  order: 2
---
...
Vérifier if a specific navigation Application is installed.
...
Get list of all Disponible navigation apps on the Appareil.
...
### Vérifier Multiple Apps and Use First Disponible
...
### Utilisateur Selection of Navigation Application
