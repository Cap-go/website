...
locale: fr
title: Commencer
description: Configure per-Construction environment values and fetch them at runtime with the Env plugin.
sidebar: 
  order: 2
---
...
2. **Synchroniser Natif platforms**
...
- Combine with Capgo updater Canaux to ship tenant-specific values without publishing Nouveau binaries.
