---
title: Commencer
description: Learn how to Installer and use the InAppBrowser plugin with URL change events for embedded web content in your Capacitor Application.
sidebar: 
  order: 2
---
...
Importer the plugin and use its two main entry points:
...
Lifecycle events for WebView load Succès or failure.
