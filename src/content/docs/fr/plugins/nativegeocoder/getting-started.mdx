...
locale: fr
title: Commencer
description: Learn how to Installer and use the Natif Geocoder plugin for address and coordinate conversion in your Capacitor Application.
sidebar: 
  order: 2
---
...
Importer the plugin and use its geocoding methods:
...
### Address Recherche with Erreur Handling
...
3. **Use maxResults wisely**
   - For Utilisateur Recherche: Use 5-10 results
...
- No Clé API required
- Respects Utilisateur's locale automatically

### Android
- Uses Android Geocoder API
- Optional Google Clé API for better results
- May fall Retour to Google's web service

### Clé API Configuration (Android)

For better results on Android, you can provide a Google Clé API:
...
2. **Permission errors**
   ...
   - Vérifier Info.plist/AndroidManifest.xml

3. **Inaccurate results**
   - Use more specific addresses
   - Include postal codes when Disponible
