---
locale: fr
title: Google Connexion on iOS
description: This Guide offers a comprehensive walkthrough for configuring Google Connexion with Capacitor on iOS, detailing each step to ensure a smooth integration process.
sidebar: 
    order: 3
---
...
In this Guide, you will learn how to Configuration Google Connexion with Capgo Social Connexion for iOS.
...
In this part, you will learn how to Configuration Google Connexion in iOS.

<Steps>
1. Créer an iOS client ID in the Google console
...
2. Modify your Application's Info.plist
...
4. Configuration Google Connexion in your JavaScript/TypeScript code
   ...
   2. Call the Initialiser method (this should be called only once)
   ...
   3. Implement the Connexion function. Créer a button and run the following code on click
...
5. Test your Application
   ...
   2. If you've done everything correctly, you should see the Google Connexion flow working properly
...
The Google Connexion plugin is incompatible with [@capacitor/privacy-screen](https://github.com/ionic-team/capacitor-privacy-screen). When using both plugins together, the Google Connexion WebView will be interrupted by the privacy screen.
