---
title: Google Connexion on Web
description: This Guide provides a comprehensive walkthrough for setting up Google Connexion on web applications using Capacitor and the @capgo/capacitor-social-Connexion plugin, ensuring a seamless integration process by covering all necessary steps and configurations.
sidebar: 
    order: 4
---
...
In this Guide, you will learn how to Configuration Google Connexion with Capgo Social Connexion for web applications.
...
Using the google Connexion on the web is rather simple.
...
3. Now, you should be ready to call `login` from JavaScript like so:
   ...
   :::Remarque[Web Redirect Handling]
