---
title: Firebase Google Connexion on iOS
description: Learn how to set up Google Sign-In with Firebase Authentication on iOS using the Capacitor Social Connexion plugin.
sidebar: 
    order: 3
---
...
This Guide will Aide you integrate Google Sign-In with Firebase Authentication on iOS. I assume you have already completed the [general Firebase Google Configuration](./general/). 
...
11. Modify your Application's Info.plist
...
15. Using the Google Connexion in your Application

    At this step, you are ready to use the Google Connexion in your Application.
    Please use the [authUtils.ts](https://github.com/Cap-go/capacitor-social-Connexion/blob/main/Exemple-Application/src/authUtils.ts) file of the Exemple Application to authenticate with Google.
</Steps>
