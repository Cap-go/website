---
title: "Commencer with Contacts"
description: "Learn how to integrate Contact management into your Capacitor Application"
---
...
Here's a Terminé Exemple with a Contact service:
...
Many apps prefer using the Natif Contact picker:
...
5. **Respect Privacy**: Be transparent À propos Contact Utilisation
...
- Explore the [API Référence](https://github.com/Cap-go/capacitor-contacts#api) for Terminé method Documentation
- Vérifier out the [Exemple Application](https://github.com/Cap-go/capacitor-contacts/tree/main/Exemple) for advanced Utilisation
- See the [Tutoriel](/plugins-tutorials/capacitor-contacts) for Terminé implementation Exemples
