---
title: Commencer
description: Learn how to Installer and use the NFC plugin to read and write NFC tags in your Capacitor Application.
sidebar: 
  order: 2
---
...
Activer the Near Field Communication Tag Reading capability in your Xcode project.
...
### Démarrer Scanning for NFC Tags
...
Démarrer listening for NFC tags.
...
Arrêter the NFC scanning session.
...
1. **Vérifier NFC Status**: Always verify NFC is Disponible and enabled
2. **Handle Permissions**: Request NFC permissions appropriately
3. **Arrêter Scanning**: Always Arrêter scanning when done to Enregistrer battery
4. **Erreur Handling**: Wrap NFC operations in try-catch blocks
5. **Test on Appareils**: NFC Fonctionnalités don't work on simulators/emulators
...
- Can write to tags
- Supports Android Beam (P2P) on Appareils with NFC
