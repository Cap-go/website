---
locale: fr
title: "Commencer with Accelerometer"
description: "Learn how to integrate accelerometer sensing into your Capacitor Application"
---
...
2. **Retirer Listeners**: Always clean up when done
3. **Filter Noise**: Use moving averages for smoother data
4. **Consider Battery**: High-frequency polling drains battery
5. **Test on Real Appareils**: Simulators don't provide accurate data
...
- Explore the [API Référence](https://github.com/Cap-go/capacitor-accelerometer#api) for Terminé method Documentation
- Vérifier out the [Exemple Application](https://github.com/Cap-go/capacitor-accelerometer/tree/main/Exemple) for advanced Utilisation
- See the [Tutoriel](/plugins-tutorials/capacitor-accelerometer) for Terminé implementation Exemples
