...
**Emplacement :** Web Dashboard → App → Statistiques
...
**Emplacement :** Web Dashboard → App → Channel → Statistiques
...
### Signature du code
Vérifiez l'integrite du bundle avec des signatures cryptographiques pour prevenir toute alteration.
...
Exiger que tous les bundles soient chiffres au niveau de l'organisation. **Emplacement :** Web Dashboard -> Organization -> Security
