...
description: "Learn how to integrate Capgo Mises à jour en direct with GitHub Actions for automated Déploiement of your Application Mises à jour."
sidebar: 
  order: 3
---
...
2. Go to **Paramètres** → **Secrets and variables** → **Actions**
...
1. Go to **Paramètres** → **Environments** in your repository
