...
description: >-
  Une référence complète de tous les types de mises à jour OTA fournis par Capgo
  : timing d'application, conditions de délai, blocage de version et méthodes de
  livraison.
sidebar:
  order: 4
locale: fr
