...
description: "What does the Application page of the Capgo webapp shows? And what you can do with it."
sidebar: 
  order: 5
---

## What does the Application page shows?

First, let's take a look at the main page of the Application:

In Capgo, an Application represents your mobile Application integrated with Capgo's live Mise à jour system. It allows you to manage Mises à jour, Canaux, and Appareils seamlessly.

<figure><img src="/main-app-page.webp" alt="Main page screenshot" /><figcaption></figcaption></figure>

Let's take a closer look at this. The main Application page is divided into several key areas:

1.  **Top Navigation Bar:** Provides access to different sections of your Application management:
...
2.  **Statistiques Display:** Visualizes Important metrics for the last billing period (data reflects Utilisation from your billing day, not the 1st of the month):
...
3.  **Summary Cards:** Offers a quick Aperçu of key counts:
...
This section corresponds to the "Information" tab (2) in the top navigation bar. Here you can view and manage crucial details and Paramètres for your Application.

<figure><img src="/app_info.webp" alt="App Information Page" /><figcaption>App Information Page</figcaption></figure>

Here's a breakdown of the Disponible fields and actions:
