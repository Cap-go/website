...
locale: fr
title: "Journaux"
description: "Understand and utilize the Application Journaux of Capgo to diagnostics and track the action of your Appareils with the Mises à jour."
sidebar: 
  order: 8
---

## Understanding Application Journaux

The Journaux page provides a detailed history of Mise à jour events and diagnostic Information for your Application. This is crucial for monitoring the Mise à jour process, Dépannage issues, and understanding how your Appareils interact with Capgo. You can access it by [clicking on your Application](/docs/webapp/main-page) and then [clicking on the "Journaux" tab (previously named "Mises à jour" in some older screenshots or Documentation)](/docs/webapp/main-Application-page).

From there you should see a page similar to this, displaying a list of Journal entries:
...
Click a row to jump to the Appareil detail page for the full history.

### Sample Journal snippet (fake data)

| Time (UTC) | Appareil ID | Action | Version | What it tells you |
|------------|-----------|--------|---------|-------------------|
...
## Exemple Journal Scenarios

To Aide you understand what the Journaux tell you, here are Exemple sequences showing real Appareil Mise à jour journeys:

### Successful Mise à jour Flow

This is what a healthy Mise à jour looks like in your Journaux:

| Time | Appareil ID | Action | Version | What it means |
|------|-----------|--------|---------|---------------|
...
### Appareil Already Up-to-Date

When a Appareil checks but already has the latest Version:

| Time | Appareil ID | Action | Version | What it means |
|------|-----------|--------|---------|---------------|
| 14:30:00 | `e5f6g7h8` | `noNew` | 1.2.0 | Device is already on the latest version, no update needed |

### Échoué Mise à jour with Restauration

When an Mise à jour fails and the Appareil rolls Retour:
...
When network issues prevent the Télécharger:
...
When your Compte reaches its Appareil limit:
...
### Canal Configuration Blocking Mises à jour

When Canal Paramètres prevent an Mise à jour:
...
## Journal codes (Capgo backend enum)
...
| Code(s) | Why the Mise à jour was blocked |
|---------|---------------------------|
...
➡️ Need deeper per-code guidance? See **[Full Journal Code Référence and Débogage Guide](/docs/plugins/updater/Débogage/#understanding-cloud-Journaux)**.

## Getting More Details À propos a Journal

If you click on a specific Journal entry, it will typically take you to the [Appareil's page](/docs/webapp/Appareils/). This allows you to see the full history for that particular Appareil, which can be very helpful for diagnosing Appareil-specific issues or understanding its Mise à jour journey.
