...
description: "Guide complet étape par étape pour intégrer votre application avec Capgo en utilisant la CLI interactive"
sidebar:
  order: 2
next: true
prev: true
...
<CardGrid>
  ...
  <a href="/docs/live-updates/update-types/"><Card title="Types de Mises à Jour" icon="book">
