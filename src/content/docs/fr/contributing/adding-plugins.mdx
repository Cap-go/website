...
| `/src/content/plugins/en/` | English tutorial files |
...
7. ### Créer Tutoriel File
   ...
   Create `/src/content/plugins/en/your-plugin-name.md`:
...
- [ ] Created tutorial in `/src/content/plugins/en/`
...
2. Review generated translations in:
   - `/src/content/plugins/de/` (German)
   - `/src/content/plugins/es/` (Spanish)
   - `/src/content/plugins/fr/` (French)
   - `/src/content/plugins/it/` (Italian)
   - `/src/content/plugins/ja/` (Japanese)
   - `/src/content/plugins/ko/` (Korean)
   - `/src/content/plugins/id/` (Indonesian)
