...
description: "Référence complète de toutes les capacités de Capgo Live Update, du système de mise à jour principal aux contrôles de déploiement avancés, analyses et fonctionnalités de collaboration d'équipe."
sidebar:
  order: 2
locale: fr
---
...
Cette page fournit un aperçu complet de toutes les fonctionnalités disponibles dans Capgo Live Updates. Chaque fonctionnalité comprend une brève description et des liens vers la documentation détaillée.
