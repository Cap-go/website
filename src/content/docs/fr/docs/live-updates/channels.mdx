...
A Live Mise à jour Canal points to a specific JS Bundle Construction of your Application that will be shared with any Appareils configured to listen to that Canal for Mises à jour. When you [Installer the Capgo Mises à jour en direct SDK](/fr/docs/getting-started/quickstart/) in your Application, any Natif binary configured to that Canal will Vérifier for Disponible Mises à jour whenever the Application is launched. You can change the Construction a Canal points to at any time and can also roll Retour to Précédent builds if needed.
...
<Aside type="tip" title="Changement Instantané de Canal avec setChannel()">
...
Consultez plus de détails et d'exemples dans la section [Désactiver les mises à jour strategy](/fr/docs/cli/commands/#disable-updates-strategy).
...
Vérifier out the [CI/CD Integration](/fr/docs/getting-started/cicd-integration/) docs to learn more À propos automating Capgo Mises à jour en direct.
...
For a more detailed walkthrough, see the [Deploying Mises à jour en direct](/fr/docs/getting-started/deploy/) Guide. Happy updating!
...
Learn how to implement these advanced use cases in our Guide: [How to Segment Utilisateurs by Plan and Canaux for Fonctionnalité Flags and A/B Test](/blog/how-to-segment-users-by-plan-and-channels/).
