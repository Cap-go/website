...
A Live Mise à jour Canal points to a specific JS Bundle Construction of your Application that will be shared with any Appareils configured to listen to that Canal for Mises à jour. When you [Installer the Capgo Mises à jour en direct SDK](/docs/getting-started/quickstart/) in your Application, any Natif binary configured to that Canal will Vérifier for Disponible Mises à jour whenever the Application is launched. You can change the Construction a Canal points to at any time and can also roll Retour to Précédent builds if needed.
...
Learn more details and Exemples in Désactiver Mises à jour strategy at /docs/cli/commands/#disable-updates-strategy.
...
For a more detailed walkthrough, see the [Deploying Mises à jour en direct](/docs/getting-started/deploy/) Guide. Happy updating!
