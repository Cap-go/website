...
Le système Live Update de Capgo comprend deux composants clés :
...
Lorsque vous téléchargez un nouveau bundle JS sur Capgo et l'attribuez à un canal, le SDK Capgo dans les applications configurées pour ce canal détectera la mise à jour et la téléchargera. La prochaine fois que l'application redémarrera, le nouveau bundle sera chargé.
...
<CardGrid stagger>
  <a href="/docs/live-updates/channels/">
    <Card title="Canaux" icon="bars">
      Apprenez à utiliser les canaux pour gérer différentes versions et cibler les mises à jour pour des utilisateurs spécifiques
    </Card>
  </a>
