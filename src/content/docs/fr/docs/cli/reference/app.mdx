...
`[appId]` est l'ID de votre application au format `comexampleapp`. Consultez la [documentation Capacitor](https://capacitorjscom/docs/cli/commands/init/) pour plus d'informations
