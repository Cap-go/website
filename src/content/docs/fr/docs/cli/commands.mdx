...
`[channelId]` le nom du canal que vous souhaitez supprimer `[appId]` votre ID d'application le format `comtestapp` est expliqué [ici](https://capacitorjscom/docs/cli/commands/init/)
...
<img src="/fail-metadatawebp" alt="Impossible de trouver les métadonnées"/>
...
[Tutoriel GitHub action](https://capgoapp/blog/automatic-build-and-release-with-github-actions/)
