...
Vous pouvez aussi totalement le désactiver, avec une chaîne vide. Gardez à l'esprit que les statistiques sont conçues de manière respectueuse de la vie privée et m'aident à comprendre comment les gens utilisent le plugin, pour résoudre les problèmes et l'améliorer
