...
## Servir votre bundle
Assurez-vous que votre bundle est servi en HTTPS, et que le serveur a les bons en-têtes CORS pour permettre à l'application de télécharger la mise à jour
...
## Configuration
Ajoutez un ``updateUrl`` à votre ``capacitorconfigjson``
