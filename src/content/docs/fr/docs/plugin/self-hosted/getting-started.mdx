...
Si vous trouvez ce travail utile, merci d'envisager de soutenir mon travail en devenant un [sponsor Github](https://github.com/sponsors/riderx)
...
Si Capgo ne vous convient pas, alors fixez votre propre prix et [soutenez un créateur indépendant](https://github.com/sponsors/riderx) selon vos conditions
