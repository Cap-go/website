...
Puisque par défaut, Android n'autorise pas `http`, capgo a implémenté une vérification pour http [ici](https://githubcom/Cap-go/capgo/blob/4cce6c0707d745faa2afbab643e636bad927c602/supabase/functions/updates/indexts#L396)
...
Ce code est là [pour une raison](https://githubcom/Cap-go/capacitor-updater/issues/37#issuecomment-1684916354)
:::
