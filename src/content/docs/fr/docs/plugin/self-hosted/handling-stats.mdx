...
description: Comment créer un endpoint de statistiques auto-hébergé
sidebar:
  order: 7
locale: fr
---
...
Cet endpoint doit retourner un JSON :
...
* **update\_fail:** quand le bundle ne parvient pas à faire `notifyAppReady` dans le délai imparti