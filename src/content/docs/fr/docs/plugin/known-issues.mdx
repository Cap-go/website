...
Ajoutez la clé de dictionnaire `NSPrivacyAccessedAPICategoryUserDefaults` à votre [Manifeste de confidentialité](https://capacitorjscom/docs/ios/privacy-manifest) (généralement `ios/App/PrivacyInfoxcprivacy`) :
