...
If you have questions not answered here, please ask! Both filing an Problème or asking on [Discord](https://discord.capgo.app) work.

### What is "code Pousser"?[](https://capgo.app/docs/faq/#what-is-code-Pousser "Direct link to What is \"code Pousser\"?")
...
### What is the difference between a Bundle and a Libération?[](https://capgo.app/docs/faq/#what-is-the-difference-between-a-Bundle-and-a-Libération "Direct link to What is the difference between a Bundle and a Libération?")
...
Our team also operates in the public, so you can see what we're working on at any time. We're happy to answer any questions you have À propos our roadmap or priorities via Github issues or [Discord](https://discord.capgo.app).
...
### How big of a dependency footprint does this Ajouter?[](https://capgo.app/docs/faq/#how-big-of-a-dependency-footprint-does-this-Ajouter "Direct link to How big of a dependency footprint does this Ajouter?")
...
### Does code Pousser work with large applications?[](https://capgo.app/docs/faq/#does-code-Pousser-work-with-large-applications "Direct link to Does code Pousser work with large applications?")

Yes. There is no limit on the size of the Application that can be updated with code Pousser. As noted [below](https://capgo.app/docs/faq/#what-types-of-changes-does-capgo-code-Pousser-Support), Capgo can change any JS code in your Application regardless of size.
...
### What can I use Capgo code Pousser for?[](https://capgo.app/docs/faq/#what-can-i-use-capgo-code-Pousser-for "Direct link to What can I use Capgo code Pousser for?")
...
Remarque that most Application stores prohibit shipping code that changes the behavior of the Application in a significant way. Please see [below](https://capgo.app/docs/faq/#how-does-this-relate-to-the-appplay-store-review-process-or-policies) for more Information.
...
### What can't we use Capgo code Pousser for?[](https://capgo.app/docs/faq/#what-cant-we-use-capgo-code-Pousser-for "Direct link to What can't we use Capgo code Pousser for?")

As above, Capgo should not be used to violate Application Store polices. Please see [below](https://capgo.app/docs/faq/#does-capgo-comply-with-play-store-guidelines) for more Information.
...
### Does Capgo Soumettre to the stores for me?[](https://capgo.app/docs/faq/#does-capgo-Soumettre-to-the-stores-for-me "Direct link to Does Capgo Soumettre to the stores for me?")
...
### What types of changes does Capgo code Pousser Support?[](https://capgo.app/docs/faq/#what-types-of-changes-does-capgo-code-Pousser-Support "Direct link to What types of changes does Capgo code Pousser Support?")
...
### How does this relate to the Application/Play Store review process or policies?[](https://capgo.app/docs/faq/#how-does-this-relate-to-the-appplay-store-review-process-or-policies "Direct link to How does this relate to the Application/Play Store review process or policies?")
...
### Does Capgo comply with Application Store guidelines?[](https://capgo.app/docs/faq/#does-capgo-comply-with-Application-store-guidelines "Direct link to Does Capgo comply with Application Store guidelines?")
...
### Does code Pousser require the internet to work?[](https://capgo.app/docs/faq/#does-code-Pousser-require-the-internet-to-work "Direct link to Does code Pousser require the internet to work?")
...
### What happens if a Utilisateur doesn't Mise à jour for a long time and misses an Mise à jour?[](https://capgo.app/docs/faq/#what-happens-if-a-Utilisateur-doesnt-Mise à jour-for-a-long-time-and-misses-an-Mise à jour "Direct link to What happens if a Utilisateur doesn't Mise à jour for a long time and misses an Mise à jour?")
...
### When do Mises à jour happen?[](https://capgo.app/docs/faq/#when-do-Mises à jour-happen "Direct link to When do Mises à jour happen?")
...
### Do I need to keep my Application\_id secret?[](https://capgo.app/docs/faq/#do-i-need-to-keep-my-app_id-secret "Direct link to Do I need to keep my app_id secret?")
...
### How does Capgo interact with Play Test Tracks or Apple TestFlight?[](https://capgo.app/docs/faq/#how-does-capgo-interact-with-play-Test-tracks-or-apple-testflight "Direct link to How does Capgo interact with Play Test Tracks or Apple TestFlight?")
...
### How do I Mise à niveau or downgrade my plan?[](https://capgo.app/docs/faq/#how-do-i-Mise à niveau-or-downgrade-my-plan "Direct link to How do I Mise à niveau or downgrade my plan?")
...
### When does my billing period Réinitialiser?[](https://capgo.app/docs/faq/#when-does-my-billing-period-Réinitialiser "Direct link to When does my billing period Réinitialiser?")
...
### How do I Annuler my subscription?[](https://capgo.app/docs/faq/#how-do-i-Annuler-my-subscription "Direct link to How do I Annuler my subscription?")
...
### Stats and Analyse[](https://capgo.app/docs/faq/#stats-and-Analyse "Direct link to Stats and Analyse")

The stats in your Tableau de bord are updated every midnight UTC.
The stats are calculated based on the number of [MAU](https://capgo.app/docs/faq/#what-is-the-difference-between-a-Bundle-and-a-Libération "Direct link to What is the difference between a Bundle and a Libération?") that have been installed on your Appareils.

## How Appareil ID is generated[](https://capgo.app/docs/faq/#how-Appareil-id-is-generated "Direct link to How Appareil ID is generated")
...
## Why my Appareil number is different than my MAU?[](https://capgo.app/docs/faq/#why-my-Appareil-number-is-different-than-my-mau "Direct link to Why my Appareil number is different than my MAU?")
...
## How to have different Mise à jour by platform?[](https://capgo.app/docs/faq/#how-to-have-different-Mise à jour-by-platform "Direct link to How to have different Mise à jour by platform?")
