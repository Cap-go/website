...
1. [Créer un compte Capgo](https://capgo.app/register)
2. [Guide de démarrage](/getting-started/quickstart/)
3. [Intégration CI/CD](/getting-started/cicd-integration/)
4. [Configuration des mises à jour](/live-updates/)
