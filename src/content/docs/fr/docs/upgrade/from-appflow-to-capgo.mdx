---
locale: fr
title: Migrer from AppFlow to Capgo
...
- Publishes latency metrics for 18 global regions at [status.capgo.Application/history](https://status.capgo.Application/history).
...
- Join the Communauté: [Capgo Discord](https://discord.gg/VCXxSVjefW)
- Track issues / request Fonctionnalités: [github.com/Cap-go/capacitor-updater](https://github.com/Cap-go/capacitor-updater)
