...
<CardGrid stagger>
  ...
  <a href="/docs/live-updates/"><Card title="Documentation des mises à jour en direct" icon="setting">
...
Le paragraphe **332** depuis 2015 de l'[accord de licence du programme pour développeurs Apple](https://developer.apple.com/programs/ios/information/) autorise pleinement l'exécution de mises à jour over-the-air de JavaScript et des assets - et dans sa dernière version (20170605) [téléchargeable ici](https://developer.apple.com/terms/) cette règle est encore plus large :
