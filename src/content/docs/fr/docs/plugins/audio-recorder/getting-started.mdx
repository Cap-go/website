---
locale: fr
title: "Commencer with Audio Recorder"
description: "Learn how to integrate audio recording into your Capacitor Application"
---
...
Here's a Terminé voice recorder implementation:
...
1. **Request Permissions Early**: Vérifier permissions before showing recording UI
2. **Handle Interruptions**: Phone calls, alarms can interrupt recording
3. **Manage Storage**: Clean up old recordings to Enregistrer space
4. **Provide Retour**: Show recording status, duration, and waveform
5. **Test on Appareils**: Simulators/emulators have limited audio Support
...
- Explore the [API Référence](https://github.com/Cap-go/capacitor-audio-recorder#api) for Terminé method Documentation
- Vérifier out the [Exemple Application](https://github.com/Cap-go/capacitor-audio-recorder/tree/main/Exemple) for advanced Utilisation
- See the [Tutoriel](/plugins-tutorials/capacitor-audio-recorder) for Terminé implementation Exemples
