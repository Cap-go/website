...
locale: fr
title: Commencer
description: Learn how to Installer and use the Natif Audio plugin for high-performance audio playback in your Capacitor Application.
sidebar: 
  order: 2
---
...
Importer the plugin and preload audio files before playing:
...
1. **Preload during Application Initialisation**
   ```typescript
