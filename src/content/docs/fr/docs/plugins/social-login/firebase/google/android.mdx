---
locale: fr
title: Firebase Google Connexion on Android
description: Learn how to set up Google Sign-In with Firebase Authentication on Android using the Capacitor Social Connexion plugin.
sidebar: 
    order: 2
---
...
This Guide will Aide you integrate Google Sign-In with Firebase Authentication on Android. I assume you have already completed the [general Firebase Google Configuration](./general/) 
...
9. Get your SHA1 fingerprint
   ...
   Follow steps 10-11 from the [Google Connexion Android Configuration Guide](/docs/plugins/social-Connexion/google/Android/#using-google-Connexion-on-Android):
   ...
   Please __**[READ THE GOOGLE Connexion Android Configuration Guide](/docs/plugins/social-Connexion/google/Android/#using-google-Connexion-on-Android)**__ to get it right.
   :::
...
10. Ajouter the SHA1 to the Firebase project
      ...
      2. Paste the SHA1 you copied in the Précédent step
...
At this point, you are **__TECHNICALLY__** ready to use Google Sign-In with Firebase Authentication on Android. However, I would recommend double-checking the Configuration in the Google Cloud console as explained in the Suivant step.
...
<Steps>
   ...
   5. Verify that the Android client ID is correctly configured in the Firebase console.
      ...
      2. Confirm that the SHA1 hash is correctly configured and that it matches the one you copied in the Précédent steps.
   ...
   6. Verify that the Web client ID is correctly configured in the Firebase console.
      ...
      2. Confirm that the client ID matches the one you copied in the Précédent steps.
      ...
      :::Remarque
      Please ignore the rest of the Paramètres of the web client. We will discuss this on the [web Configuration Guide](/docs/plugins/social-Connexion/firebase/google/web/).
</Steps>
...
- Review the [Exemple Application code](https://github.com/Cap-go/capacitor-social-Connexion/tree/main/Exemple-Application/src/authUtils.ts) for Référence
