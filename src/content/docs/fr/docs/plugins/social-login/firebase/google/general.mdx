---
locale: fr
title: Firebase Google Connexion - General Configuration
description: Learn how to set up Google Sign-In with Firebase Authentication using the Capacitor Social Connexion plugin.
sidebar: 
    order: 1
---
