...
title: Démarrage
description: >-
  Apprenez comment installer et utiliser le plugin Compass pour lire la direction de la boussole de l'appareil dans votre application Capacitor.
sidebar:
  order: 2
locale: fr
---
...
Sur iOS, l'accès à la boussole nécessite une permission de localisation. Ajoutez les éléments suivants à votre `Info.plist`:
...
Aucune configuration supplémentaire requise. Le plugin utilise les capteurs magnétométre et accéléromètre de l'appareil.

## Utilisation

Importez le plugin et utilisez ses méthodes pour lire la direction de la boussole:
