---
title: "Applications"
description: "Documentation détaillée pour le endpoint Applications, fournissant des informations complètes sur la gestion et l'interaction avec les applications Capacitor via la plateforme Capgo."
sidebar:
  order: 7
---
