...
title: Canaux
description: >-
  Guide de gestion des canaux de mise à jour d'applications dans Capgo, couvrant
  le contrôle de version, le ciblage de plateforme et les politiques de mise à
  jour.
sidebar:
  order: 6
locale: fr
