---
title: "Bundles"
description: "Guide détaillé pour gérer les Capgo Bundles, couvrant le listage, la suppression, le versionnage et l'optimisation du stockage pour les packages de mise à jour d'applications."
sidebar:
  order: 8
---
