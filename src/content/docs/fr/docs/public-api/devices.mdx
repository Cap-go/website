---
title: "Devices"
description: "Documentation pour gérer les appareils via l'API Capgo, couvrant le suivi, le versionnage et les affectations de canaux pour les installations d'applications."
sidebar:
  order: 7
---
