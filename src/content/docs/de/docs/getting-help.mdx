...
description: "So erhalten Sie Tech Support für Capgo und unseren Updater. Bitte folgen Sie dieser Anleitung, um Hilfe zu erhalten, wenn die Dokumentation und unsere Artikel nicht ausreichen"
sidebar:
  order: 1
locale: de
---
