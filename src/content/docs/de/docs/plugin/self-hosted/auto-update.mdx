...
Diese Dokumentation erklärt, wie Sie Ihren Auto-Update-Server betreiben.
...
Das Plugin führt bei jedem Öffnen der App einen POST-Aufruf an Ihre API mit diesem Body durch:
...
Die Server-API sollte in JSON auf das Capacitor-Updater-Plugin mit diesen Daten antworten, wenn ein Update erforderlich ist:
