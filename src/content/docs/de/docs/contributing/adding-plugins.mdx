...
| `/src/content/plugins/en/` | Englische Tutorial-Dateien |
...
7. ### Tutorial-Datei erstellen
   ...
   Erstellen Sie `/src/content/plugins/en/your-plugin-name.md`:
...
- [ ] Tutorial in `/src/content/plugins/en/` erstellt
...
2. Generierte Übersetzungen überprüfen in:
   - `/src/content/plugins/de/` (Deutsch)
   - `/src/content/plugins/es/` (Spanisch)
   - `/src/content/plugins/fr/` (Französisch)
   - `/src/content/plugins/it/` (Italienisch)
   - `/src/content/plugins/ja/` (Japanisch)
   - `/src/content/plugins/ko/` (Koreanisch)
   - `/src/content/plugins/id/` (Indonesisch)
