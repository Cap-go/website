...
description: Vollständiger Leitfaden zum Bestehen der Google Play-Überprüfung mit In-App-Käufen und Abonnements, einschließlich Compliance-Anforderungen und Bewährte Methoden.
locale: de
sidebar:
  order: 11
---
...
![UI-Design Bewährte Methoden](/native-purchases/review-guides/ui-design-dos-donts.webp)
...
![Beschreibungs-Bewährte Methoden](/native-purchases/review-guides/description-guidelines-1.webp)
...
## Bewährte Methoden für Native Purchases
...
- [Abonnement-Bewährte Methoden](https://developer.android.com/google/play/billing/subscriptions)
