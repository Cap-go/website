---
title: Funktionen
description: "Vollständige Referenz aller Capgo Live Update-Funktionen, vom Kern-Update-System bis zu erweiterten Bereitstellungssteuerungen, Analysen und Team-Kollaborationsfunktionen."
sidebar:
  order: 2
locale: de
---
