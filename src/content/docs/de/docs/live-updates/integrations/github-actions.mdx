...
locale: de
description: "Erfahren Sie, wie Sie Capgo Live Updates mit GitHub Actions für die automatisierte Bereitstellung Ihrer App-Updates integrieren."
sidebar:
  order: 3
---
...
**Workflow schlägt mit "CAPGO_TOKEN not found" fehl:**
