...
title: Apps
description: >-
  Detaillierte Dokumentation für den Apps-Endpunkt, die umfassende Einblicke in
  die Verwaltung und Interaktion mit Capacitor-Anwendungen über die
  Capgo-Plattform bietet.
sidebar:
  order: 7
locale: de
---
