---
title: "Bundles"
description: "Detaillierte Anleitung zur Verwaltung von Capgo Bundles, einschließlich Auflistung, Löschen, Versionierung und Speicheroptimierung für App-Update-Pakete."
sidebar:
  order: 8
---

Bundles sind die Kern-Update-Pakete in Capgo. Jedes Bundle enthält die Web-Assets (HTML, CSS, JS), aus denen der Inhalt Ihrer App besteht. Die Bundles-API ermöglicht es Ihnen, diese Update-Pakete zu verwalten, einschließlich deren Auflistung und Löschung.

## Bundles verstehen

Ein Bundle repräsentiert eine bestimmte Version des Web-Inhalts Ihrer App und umfasst:
- **Version**: Semantische Versionsnummer des Bundles
- **Checksum**: Eindeutiger Hash zur Überprüfung der Bundle-Integrität
- **Storage Info**: Details darüber, wo und wie das Bundle gespeichert ist
- **Native Requirements**: Mindestanforderungen an die native App-Version
- **Metadata**: Erstellungszeit, Eigentümerschaft und andere Tracking-Informationen

## Manuelle Bundle-Erstellung (Ohne CLI)

So erstellen und laden Sie Bundles manuell hoch, ohne die Capgo CLI zu verwenden:
...
**Wichtig**: Verwenden Sie genau dieselben JavaScript-Pakete, die Capgo CLI intern verwendet, um Kompatibilität sicherzustellen.
...
#### Zip-Bundle mit JavaScript erstellen (Wie Capgo CLI)
...
### Schritt 3: SHA256-Prüfsumme mit demselben Paket wie CLI berechnen
