...
<Card title="🚀 Benötigen Sie Experten-Hilfe?" icon="rocket">
  ...
  <div style="margin-top: 1rem;">
    <a href="/de/consulting/" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background-color: #2563eb; color: white; text-decoration: none; border-radius: 0.5rem; font-weight: 600; transition: background-color 0.2s;">
