...
description: "Schließen Sie Ihre Capgo-Reise mit einem prägnanten Überblick über wichtige Konzepte und nächste Schritte ab und stellen Sie eine solide Grundlage für zukünftige Erkundungen und Beherrschung sicher."
sidebar:
  order: 7
next: false
prev: false
...
<CardGrid stagger>
  ...
  <a href="/docs/live-updates/">
    <Card title="Live-Updates" icon="cloud-download">
      Tauchen Sie tiefer in die Live-Update-Funktionen und Bewährte Methoden von Capgo ein.
    </Card>
  </a>

  <a href="/docs/faq/">
    <Card title="FAQ" icon="open-book">
      Finden Sie Antworten auf häufige Fragen zu Capgo.
    </Card>
  </a>
