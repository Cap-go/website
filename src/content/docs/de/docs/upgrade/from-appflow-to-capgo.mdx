...
1. [Capgo-Konto erstellen](https://capgo.app/register)
2. [Schnellstart-Anleitung](/getting-started/quickstart/) befolgen
3. [CI/CD-Integration](/getting-started/cicd-integration/) einrichten
4. [Live-Updates](/live-updates/) konfigurieren
