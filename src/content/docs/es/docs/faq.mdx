...
Puedes actualizar o bajar de categoría tu plan en cualquier momento en tu panel de control: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
...
Puedes cancelar tu suscripción en cualquier momento en tu panel de control: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)

### ¿Puedo pagar por un año por adelantado?

Sí, puedes hacerlo en cualquier momento en tu panel de control: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
