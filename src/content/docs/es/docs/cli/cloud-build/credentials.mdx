...
import { Pasos, Aside } from '@astrojs/starlight/components';
...
- [Guía de Certificados iOS (Capgo)](https://capgo.app/cloud/native-builds/certificates/ios/) - Tutorial detallado con capturas de pantalla
...
- [Guía de Certificados Android (Capgo)](https://capgo.app/cloud/native-builds/certificates/android/) - Tutorial detallado con capturas de pantalla
