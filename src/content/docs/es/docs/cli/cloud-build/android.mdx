...
description: Configura y compila aplicaciones Android con Capgo Construcción en la nube
locale: es
sidebar:
  order: 3
---

import { Pasos, Aside, Card, CardGrid } from '@astrojs/starlight/components';
...
<CardGrid>
  <Card title="⚠️ Configura las Credenciales de Android Primero" icon="Advertencia">
...
|------------|-------------------|---------|
| **Depuración** | No | Solo pruebas, autogenerado |
| **Lanzamiento** | Sí | Envío a Play Store |

## Crear un Keystore

<Aside type="Consejo">
Para guías detalladas paso a paso con capturas de pantalla, visita:
- [Guía de Certificados Android](https://capgo.app/cloud/native-builds/certificates/android/)
...
<Aside type="Consejo">
Para instrucciones detalladas con capturas de pantalla, consulta la [Guía de Certificados Android](https://capgo.app/cloud/native-builds/certificates/android/).
</Aside>
...
3. **Otorgar Permisos en Play Console**
   ...
   - En "Permisos de cuenta", otorga:
     ...
     - **Lanzamientos**: "Lanzar a producción, excluir dispositivos y usar Play Aplicación Signing"
...
Esto crea un APK de Depuración que se puede instalar en cualquier dispositivo para pruebas.
...
3. **Compilación Gradle** (2-4 minutos)
   ...
   - Compilación APK/AAB
   - Optimización ProGuard/R8 (modo Lanzamiento)
...
- **AAB** (Android Aplicación Paquete): Formato recomendado por Google Play (descargas más pequeñas para usuarios)

Por defecto, las compilaciones de Capgo crean:
- **Modo Depuración**: APK
- **Modo Lanzamiento**: AAB (optimizado para Play Store)
...
|------------|--------------|
| Depuración | 2-3 minutos |
| Lanzamiento (sin ProGuard) | 3-4 minutos |
| Lanzamiento (con ProGuard) | 4-6 minutos |
