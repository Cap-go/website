...
description: Configura y compila aplicaciones iOS con Capgo Cloud Build
locale: es
sidebar:
  order: 2
---
...
<CardGrid>
  <Card title="⚠️ Configura las Credenciales iOS Primero" icon="warning">
...
- [Guía de Certificados iOS](https://capawesome.io/cloud/native-builds/certificates/ios/)
...
### Compilación de Debug (Development)
...
### Compilación de Release (App Store)
