...
- `--min-update-version <minUpdateVersion>`: Versión mínima de la Aplicación requerida para aplicar esta actualización (solo se usa si la auto-actualización está deshabilitada vía metadata)
