...
Si utilizas este trabajo por tu cuenta, no podría sugerirte más que apoyes mi trabajo a través de [Github support](https://github.com/sponsors/riderx/)
...
Si la oferta de Capgo no te conviene, entonces pon tu precio y apoya a un Creador bootstrapped [AQUÍ](https://github.com/sponsors/riderx/) en tus términos
