...
2. En el código de tu aplicación, llama a `CapacitorUpdaternotifyAppReady()` después de que tu aplicación haya terminado de inicializarse. Esto le indica al SDK de Capgo que tu aplicación está lista para recibir actualizaciones
