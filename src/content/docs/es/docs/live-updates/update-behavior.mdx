...
<Aside type="tip" title="Recomendado: Usar Delta Updates con Direct Update">
Al usar `directUpdate`, **recomendamos encarecidamente** habilitar [Delta Updates](/docs/live-updates/differentials/) para minimizar los tiempos de descarga y mejorar la experiencia del usuario. Las Delta Updates solo descargan archivos modificados en lugar del bundle completo, lo cual es especialmente importante cuando las actualizaciones se aplican inmediatamente mientras los usuarios están usando activamente tu aplicación.

**Por qué esto es importante para Direct Updates:**
...
Para habilitar Delta Updates, simplemente usa el flag `--partial` al subir bundles:
```shell
