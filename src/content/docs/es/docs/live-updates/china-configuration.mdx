...
description: "Aprende cómo configurar Capgo Live Updates para funcionar en China usando URLs OST regionales para rendimiento y confiabilidad óptimos."
locale: es
sidebar:
  order: 11
---
...
1. Sube un nuevo bundle a Capgo:
...
4. **Prueba actualizaciones** - Intenta subir un nuevo bundle y monitorear el proceso de descarga
