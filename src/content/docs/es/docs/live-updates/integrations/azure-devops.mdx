...
Primero, configure las variables necesarias en su proyecto de Azure DevOps:
...
Configure diferentes estrategias de despliegue según las ramas de Git:
...
1. **Use grupos de variables**: Almacene datos sensibles en grupos de variables de Azure DevOps
...
Configure notificaciones por correo electrónico para el estado del despliegue:
...
- Configure [Comportamiento de actualización](/docs/live-updates/update-behavior/) para personalizar cómo se aplican las actualizaciones
