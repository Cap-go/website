...
description: "Referencia completa de todas las capacidades de Capgo Live Update, desde el sistema de actualización principal hasta controles de implementación avanzados, análisis y funciones de colaboración en equipo."
sidebar:
  order: 2
locale: es
---
...
Esta página proporciona una descripción completa de todas las funciones disponibles en Capgo Live Updates. Cada función incluye una breve descripción y enlaces a documentación detallada.
