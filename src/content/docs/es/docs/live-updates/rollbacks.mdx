...
- El bundle JavaScript se cargó sin errores críticos
...
2. Revertirá automáticamente al bundle anterior que funciona
...
En situaciones más severas, podrías querer revertir todos los dispositivos en un canal de vuelta a la compilación web que originalmente se empaquetó con el binario nativo de tu aplicación. Esto se conoce como el "bundle incorporado".
...
2. Haz clic en el botón "Built-in Bundle".

3. Confirma que quieres forzar el bundle incorporado.

</Steps>

Cuando fuerzas el bundle incorporado, todos los dispositivos configurados para ese canal revertirán de vuelta a la compilación web empaquetada original en su próxima verificación de actualización. Esto sucede independientemente de en qué compilación estén actualmente.
...
- Tener un proceso de decisión claro para cuándo revertir, desvincular o forzar el bundle incorporado, y quién tiene la autoridad para hacerlo
