...
<Aside type="caution" title="Los canales no proporcionan confidencialidad">
Los canales controlan la elegibilidad de actualización, no el secreto del bundle. Aunque un canal sea privado o tenga desactivada la autoasignación, cualquier bundle sin cifrar subido a Capgo debe seguir tratándose como un activo público entregado a los clientes. El cifrado protege la ruta de entrega y la autenticidad de las actualizaciones, pero los bundles distribuidos todavía pueden ser objeto de ingeniería inversa desde la app distribuida con suficiente esfuerzo porque la clave pública forma parte del cliente. Consulta [el cifrado de Live Updates](/docs/live-updates/encryption/) para más detalles.
</Aside>
...
<Aside type="tip" title="Cambio Instantáneo de Canal con setChannel()">
