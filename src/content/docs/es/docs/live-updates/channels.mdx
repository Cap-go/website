...
Consulta la documentación de [Integración CI/CD](/docs/getting-started/cicd-integration/) para aprender más sobre la automatización de actualizaciones en vivo de Capgo.
