...
| **Eliminar**            | Un paquete ha sido eliminado en el dispositivo                                        |
| **Establecer**               | Un paquete ha sido establecido en el dispositivo                                              |
...
<LinkCard
    title="Getting El Dispositivo Registro in Xcode"
    href="https://intercomhelp/deploygate/en/articles/4682692-getting-the-Dispositivo-Registro-in-xcode"
/>
...
<LinkCard
    title="View Registros with Logcat"
    href="https://developerandroidcom/studio/Depuración/am-logcat"
/>
...
* Conecta tu dispositivo a tu Mac y selecciona Window > Dispositivos en la barra de menú de Xcode
* Selecciona tu dispositivo en el panel izquierdo bajo la sección Dispositivos
...
Seleccionar Descargar Container descargará y exportará una instantánea del sistema de archivos como un archivo xcappdata que puedes navegar

Haz clic derecho en este archivo y selecciona Show Paquete Contents para abrir la carpeta

Abre la carpeta Aplicación Data, y ahora deberías ver algunas carpetas como Documents, Library, tmp, etc
...
* Haz clic en View > Tool Windows > Dispositivo File Explorer o haz clic en el botón Dispositivo File Explorer en la barra de herramientas para abrir el Dispositivo File Explorer
...
<LinkCard
    title="Cómo review your Aplicación's crash Registros"
