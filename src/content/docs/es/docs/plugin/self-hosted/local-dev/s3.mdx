...
## Configurando las funciones edge
...
Para hacer esto necesitamos crear un archivo ENV en `capgo/supabase` llamado `envlocal`
...
const config: CapacitorConfig = {
  ...
  plugins: {
    CapacitorUpdater : {
      // Sin este localS3 el comando de subida fallará
      localS3: true
    },
  },
};
