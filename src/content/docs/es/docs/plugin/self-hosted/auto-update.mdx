...
```
:::caution
Cuando estés publicando una actualización auto-alojada, ten en cuenta que no puedes usar endpoints "HTTP" ya que va en contra de las políticas de seguridad de las aplicaciones Android, para fines de prueba puedes [permitirlo](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted)
:::
