...
```
:::caution
Cuando estás enviando una actualización auto-alojada, ten en cuenta que no puedes usar endpoints "HTTP" ya que va en contra de las políticas de seguridad de las aplicaciones Android, para propósitos de prueba puedes [permitirlo](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted)
:::
...
Si añades las claves "message" y "error", la versión no se establecerá, y el mensaje se mostrará en los registros en su lugar
