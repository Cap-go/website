...
| **`updateUrl`**              | <code>string</code>  | Configura la URL / punto final al que se envían las comprobaciones de actualización. Solo disponible para Android e iOS                                                                       | <code>https://plugincapgo.app/updates</code>      | |
| **`channelUrl`**             | <code>string</code>  | Configura la URL / punto final para operaciones de canal. Solo disponible para Android e iOS                                                                                                  | <code>https://plugincapgo.app/channel_self</code> | |
| **`statsUrl`**               | <code>string</code>  | Configura la URL / punto final al que se envían las estadísticas de actualización. Solo disponible para Android e iOS. Establecer como "" para deshabilitar el reporte de estadísticas      | <code>https://plugincapgo.app/stats</code>        | |
