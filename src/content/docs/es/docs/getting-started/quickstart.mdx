...
3. Activar la carga de bundles en Capgo al enviar commits

4. Configurar y personalizar la publicación de bundles de Capgo
...
<CardGrid stagger>
  ...
  <a href="/docs/getting-started/deploy/"><Card title="Enviar actualizaciones" icon="pencil">
    Envía actualizaciones a tu aplicación desde el panel de Capgo.
  </Card></a>
  <a href="/docs/getting-started/cicd-integration/"><Card title="Automatizar actualizaciones" icon="pencil">
    Integra Capgo con tu CI/CD y activa cargas de bundles en Capgo al enviar commits.
  </Card></a>
...
Esto permite completamente Capacitor-updater ya que solo actualiza los bundles JS y no actualizará código nativo.
