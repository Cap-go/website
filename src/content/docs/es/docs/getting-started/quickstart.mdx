...
Si autohostas y encuentras útil esta herramienta, considera apoyar mi trabajo convirtiéndote en un [patrocinador de GitHub](https://githubcom/sponsors/riderx/)
...
Para hacer esto posible, es necesario que todos hagamos nuestra parte, incluyéndote a ti 🥹 Si Capgo cloud no satisface tus necesidades, puedes respaldar a un creador independiente [aquí](https://githubcom/sponsors/riderx/) en tus propios términos
