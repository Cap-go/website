...
description: "Guía completa paso a paso para incorporar tu aplicación con Capgo usando la CLI interactiva"
sidebar:
  order: 2
next: true
prev: true
...
<CardGrid>
  ...
  <a href="/docs/live-updates/update-types/"><Card title="Tipos de Actualización" icon="book">
