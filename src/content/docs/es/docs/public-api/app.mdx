...
title: Aplicaciones
description: >-
  Documentación detallada para el endpoint de Aplicaciones, proporcionando
  información completa sobre la gestión e interacción con aplicaciones Capacitor
  a través de la plataforma Capgo.
sidebar:
  order: 7
locale: es
---
