---
title: "Devices"
description: "Documentación para gestionar dispositivos a través de la API de Capgo, que cubre seguimiento, versiones y asignaciones de canales para instalaciones de aplicaciones."
sidebar:
  order: 7
---

Los Devices representan instalaciones individuales de su aplicación que son gestionadas por Capgo. La API de Devices le permite rastrear y gestionar dispositivos, incluyendo sus versiones, canales y estado de actualización.
...
4. **Identificación Personalizada**: Use IDs personalizados para integrar con sus sistemas existentes
...
2. **Pruebas**: Use IDs personalizados para identificar fácilmente los dispositivos de prueba
