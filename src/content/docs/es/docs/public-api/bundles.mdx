---
title: "Bundles"
description: "Guía detallada para gestionar Capgo Bundles, cubriendo listado, eliminación, versionado y optimización de almacenamiento para paquetes de actualización de aplicaciones."
sidebar:
  order: 8
---

Los Bundles son los paquetes de actualización principales en Capgo. Cada bundle contiene los assets web (HTML, CSS, JS) que componen el contenido de tu aplicación. La API de Bundles te permite gestionar estos paquetes de actualización, incluido su listado y eliminación.

## Entendiendo los Bundles

Un bundle representa una versión específica del contenido web de tu aplicación e incluye:
- **Version**: Número de versión semántica del bundle
- **Checksum**: Hash único para verificar la integridad del bundle
- **Storage Info**: Detalles sobre dónde y cómo se almacena el bundle
- **Native Requirements**: Requisitos mínimos de versión de la aplicación nativa
- **Metadata**: Tiempo de creación, propiedad y otra información de seguimiento

## Creación Manual de Bundle (Sin CLI)

Aquí se explica cómo crear y cargar bundles manualmente sin usar la CLI de Capgo:

### Paso 1: Construir tu Aplicación

Primero, construye los assets web de tu aplicación:

```bash
npm run build
```

### Paso 2: Crear Bundle Zip usando los mismos paquetes que Capgo CLI

**Importante**: Usa exactamente los mismos paquetes de JavaScript que Capgo CLI usa internamente para asegurar compatibilidad.
...
#### Crear Bundle Zip con JavaScript (Igual que Capgo CLI)
...
### Paso 3: Calcular Checksum SHA256 usando el mismo paquete que CLI
...
### Paso 4: Subir Bundle a tu Almacenamiento
...
### Paso 5: Registrar Bundle con la API de Capgo
...
## Requisitos de Estructura del Bundle
...
### Cálculo de Checksum en JavaScript (Igual que Capgo CLI)
