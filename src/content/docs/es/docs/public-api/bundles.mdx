...
title: Bundles
description: >-
  Guía detallada para gestionar Capgo Bundles, cubriendo listado, eliminación,
  versionado y optimización de almacenamiento para paquetes de actualización de
  aplicaciones.
sidebar:
  order: 8
locale: es
