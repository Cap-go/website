...
description: Plugin de inicio de aplicaciones de navegación para apps Capacitor con soporte para Google Maps, Apple Maps, Waze y otros servicios de navegación.
locale: es
...
<CardGrid stagger>
  <Card title="Soporte multi-app" icon="rocket">
  ...
  <Card title="Detección de apps" icon="magnifier">
