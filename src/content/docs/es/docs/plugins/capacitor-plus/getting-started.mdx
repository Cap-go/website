...
Importar { Code, Pasos, Aside } De '@astrojs/starlight/components';
...
4. **Agregar plataformas**
   <PackageManagers type="exec" pkg="cap" args="Agregar android" pkgManagers={['npm', 'pnpm', 'yarn', 'bun']} />
   <PackageManagers type="exec" pkg="cap" args="Agregar ios" pkgManagers={['npm', 'pnpm', 'yarn', 'bun']} />
</Pasos>
...
<Pasos>
1. **Abre un Problema** en el [repositorio de Capacitor+](https://github.com/Cap-go/capacitor-plus/issues) enlazando a tu PR upstream
...
Reporta Problemas en el [repositorio de GitHub de Capacitor+](https://github.com/Cap-go/capacitor-plus/issues). Para problemas que también afectan a Capacitor oficial, ayudaremos a coordinar upstream.
