...
description: Learn how to install and use the FFmpeg plugin for video processing in your Capacitor app.
sidebar:
  order: 2
---
...
4. **Show progress to users**
   Video processing can be slow - inform users:
   ```typescript
...
5. **Clean up temporary files**
   Remove intermediate files to save storage:
   ```typescript
...
2. **Use hardware acceleration**: Let the native platform optimize encoding
3. **Process in background**: Don't block UI during video processing
4. **Monitor memory usage**: Large videos can consume significant memory
