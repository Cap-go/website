---
title: Primeros pasos con RealtimeKit
description: ''
locale: es
---
...
## Configuración de llamadas de Cloudflare
...
- Explore la [Referencia API](https://github.com/Cap-go/capacitor-realtimekit#api) para obtener documentación completa del método
- Leer [Documentación de llamadas de Cloudflare](https://developers.cloudflare.com/calls/)
- Consulte la [aplicación de ejemplo](https://github.com/Cap-go/capacitor-realtimekit/tree/main/example)
- Consulte el [tutorial](/plugins/capacitor-realtimekit) para una implementación completa.
