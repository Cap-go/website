...
hero:
  ...
  actions:
    - text: Comenzar
      Enlace: /docs/Plugins/twilio-voice/getting-started/
      icon: right-arrow
      variant: primary
    - text: GitHub
      Enlace: https://GitHub.com/Cap-go/Capacitor-twilio-voice/
      icon: external
      variant: minimal
---
...
<CardGrid stagger>
  ...
  <Card title="Soporte de plataforma" icon="approve-Verificar">
