...
| **`updateUrl`**              | <code>string</code>                             | Configura la URL / endpoint al que se envían las verificaciones de actualización. Solo disponible para Android e iOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | <code>https://plugin.capgo.app/Actualizaciones</code>      |         |
