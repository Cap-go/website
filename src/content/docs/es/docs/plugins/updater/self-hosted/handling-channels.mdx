...
### 3. Desasignar Canal (Solicitud DELETE)

Cuando el plugin llama a `unsetChannel()`, envía una solicitud DELETE para eliminar la asignación de canal del dispositivo.
