...
1. **Descarga de Bundle**: El plugin descarga bundles de actualización (archivos ZIP que contienen tus assets web)
2. **Extracción**: Los bundles se extraen al almacenamiento del dispositivo
3. **Hot Reload**: La aplicación cambia al nuevo bundle sin requerir un reinicio
...
No se requiere configuración adicional. El plugin funciona out of the box.
...
- Mantén los tamaños de bundle pequeños para descargas más rápidas
