...
locale: es
description: Guía paso a paso para crear suscripciones renovables automáticamente en App Store Connect para el plugin native-purchases.
sidebar:
  order: 8
---
...
3. Completar la información bancaria y fiscal en App Store Connect
...
8. **Imagen Promocional de App Store (Opcional)**
   ...
   :::note
   Aunque las imágenes son opcionales para el envío inicial, son requeridas para la visualización promocional en App Store. Puedes agregarlas más tarde.
   :::
...
:::tip
¡Puedes probar suscripciones en modo sandbox incluso si muestran "Missing Metadata" o "Ready to Submit"!
:::
