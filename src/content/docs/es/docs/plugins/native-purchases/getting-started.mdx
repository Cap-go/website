...
description: Learn how to install and use the @capgo/native-purchases plugin to implement one-time purchases and subscriptions with StoreKit 2 and Google Play Billing 7.
sidebar:
order: 2
locale: es---
...
5. **Implement purchase & restore flows**
   ...
   <Tabs>
     <TabItem label="iOS">
       ...
       - Use StoreKit Local Testing or Sandbox testers for QA.<br />
       - No manifest edits required. Make sure your products are approved.
     </TabItem>
     <TabItem label="Android">
       - Create in-app products and subscriptions in Google Play Console.<br />
       - Upload at least an internal test build and add license testers.<br />
