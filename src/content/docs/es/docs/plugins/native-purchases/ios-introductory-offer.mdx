...
1. **Navegar a la Suscripción**
   ...
   En Aplicación Store Connect, ve a la sección **Monetize > Subscriptions** de tu aplicación y selecciona la suscripción a la que deseas agregar una oferta.
...
3. **Crear Oferta Introductoria**
   ...
   Selecciona **"Crear introductory offer"** de las opciones.
...
7. **Guardar**
   ...
   Haz clic en **Guardar** para crear la oferta introductoria. Estará disponible para pruebas inmediatamente en modo sandbox.
...
- Verifica si la oferta está activada en Aplicación Store Connect
...
- Espera la sincronización de Aplicación Store (puede tomar 2-3 horas)
...
- Espera que la prueba se Completo naturalmente
