---
title: Directrices de revisión de App Store de iOS para IAP
locale: es
description: Guía completa para aprobar la revisión de App Store con compras y suscripciones en la aplicación, incluyendo razones comunes de rechazo y mejores prácticas.
sidebar:
  order: 10
---
...
Lograr la aprobación de tu aplicación en App Store requiere una atención cuidadosa a las directrices de Apple, especialmente al implementar compras y suscripciones en la aplicación. Esta guía cubre todo lo que necesitas saber para aprobar la revisión en tu primer envío.

![iOS App Store Review Process](/native-purchases/review-guides/ios-review-hero.webp)

## Requisitos de compras en la aplicación

### Transparencia de precios (Crítico)

Apple requiere una divulgación de precios cristalina antes de cualquier compra:

**Elementos imprescindibles:**
- Mostrar el precio exacto antes del botón de compra
- Mostrar la frecuencia de facturación (por ejemplo, "$9.99/mes")
- Indicar claramente qué obtienen los usuarios por su dinero
- Indicar cuándo se realizarán los cargos
