...
- API key opcional de Google para mejores resultados
- Puede recurrir al servicio web de Google

### Configuración de API Key (Android)

Para mejores resultados en Android, puedes proporcionar una API key de Google:
...
2. **Errores de permisos**
   ...
   - Verifica Info.plist/AndroidManifest.xml
