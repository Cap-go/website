...
Antes de usar este plugin, debes registrar tu aplicación en la [Plataforma Abierta de WeChat](https://open.weixin.qq.com/) para obtener un App ID.
...
2. **Registro de la Aplicación**: Debes registrar tu aplicación en la [Plataforma Abierta de WeChat](https://open.weixin.qq.com/) para obtener un App ID.

3. **Universal Links (iOS)**: Para iOS 13+, necesitas configurar Universal Links para los callbacks de WeChat.
...
- Requiere configuración de Universal Links para iOS 13+
