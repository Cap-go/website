...
locale: es
description: Aprende cómo configurar el inicio de sesión de Google con Supabase Authentication en Web usando el Plugin Capacitor Inicio de sesión social.
sidebar:
    order: 4
---
...
:::Advertencia[Crítico: Manejo de Redirección]
