...
locale: es
description: Aprende cómo configurar el inicio de sesión de Google con Supabase Authentication en iOS usando el Plugin Capacitor Inicio de sesión social.
sidebar:
    order: 3
---
...
:::Advertencia[Problema de Caché de Nonce en iOS]
...
- **Discrepancia de nonce**: La función reintenta automáticamente - revisa los Registros de la consola para detalles. Si persiste, cierra sesión manualmente primero
...
- **Configuración de Información.plist**: Asegúrate de que Información.plist tenga los esquemas de URL correctos y GIDClientID
