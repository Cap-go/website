...
locale: es
description: Aprende cómo configurar el inicio de sesión de Google con Supabase Authentication usando el plugin Capacitor Social Login.
sidebar:
    order: 1
---
