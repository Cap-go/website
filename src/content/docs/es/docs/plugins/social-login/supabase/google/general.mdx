---
title: Inicio de Sesión de Google con Supabase - Configuración General
locale: es
description: Aprende cómo configurar el inicio de sesión de Google con Supabase Authentication usando el Plugin Capacitor Inicio de sesión social.
sidebar:
    order: 1
---
...
2. Leído la guía de [Configuración General de inicio de sesión de Google](/docs/plugins/social-login/google/general/) para configurar las credenciales OAuth de Google
3. Seguido las respectivas guías específicas de plataforma para configurar las credenciales OAuth de Google para tu plataforma objetivo:
    - [Configuración de Android](/docs/plugins/social-login/google/android/)
    - [Configuración de iOS](/docs/plugins/social-login/google/ios/)
    - [Configuración Web](/docs/plugins/social-login/google/web/)

    :::Nota
        Antes de comenzar el Tutorial de Supabase, necesitas generar los IDs de cliente para las plataformas que planeas usar.
        Los usarás en el paso 7 de esta guía.
    :::
...
3. Ve al menú de `Authentication`
    <img src="/social-login-assets/supabase_authentication_menu.webp" alt="Menú de Autenticación de Supabase" />
4. Haz clic en la pestaña `Providers`
    <img src="/social-login-assets/supabase_providers_tab.webp" alt="Pestaña de Proveedores de Supabase" />
...
:::Nota
__**NO DEBES**__ configurar `Client Secret (for OAuth)` o `Callback URL (for OAuth)`. Algunas fuentes también podrían sugerir configurar `Skip nonce checks` para Google en iOS, pero con esta guía no es necesario.
:::
...
:::Consejo[Implementación Completa]
...
La implementación genera un par de nonce seguro siguiendo los [requisitos de nonce de Supabase](https://react-native-google-signin.github.io/docs/security#usage-with-supabase):
...
La implementación completa está disponible en el archivo [`supabaseAuthUtils.ts` de la aplicación de ejemplo](https://github.com/Cap-go/capacitor-social-login/blob/main/example-app/src/supabaseAuthUtils.ts), que incluye:
...
- [SupabasePage.tsx](https://github.com/Cap-go/capacitor-social-login/blob/main/example-app/src/SupabasePage.tsx) - Componente de ejemplo con manejo de redirección (Web)
...
- [Configuración de Android](../android/)
- [Configuración de iOS](../ios/)
- [Configuración Web](../web/)
