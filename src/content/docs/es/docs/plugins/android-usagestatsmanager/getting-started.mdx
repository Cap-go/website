---
title: Comenzando
description: Aprende cómo instalar y usar el plugin Android Usage Stats Manager para acceder a estadísticas de uso de aplicaciones y datos de uso del dispositivo.
sidebar:
  order: 2
locale: es
---
