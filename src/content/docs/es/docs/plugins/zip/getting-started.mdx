...
title: Comenzando
locale: es
description: Aprende cómo instalar y usar el plugin Zip para comprimir y extraer archivos en tu aplicación Capacitor.
sidebar:
  order: 2
---
...
Import the plugin and zip or unzip files:
...
1. **Path Validation**: Always validate source and destination paths before operations
...
4. **Large Files**: Be cautious with large archives on mobile devices
