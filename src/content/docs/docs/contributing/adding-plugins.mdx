...
The website currently ships English content only. Keep plugin tutorials in:

- `/src/content/plugins-tutorials/en/`

The i18n setup remains in place, but non-English website content is intentionally not published.
