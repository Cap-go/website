...
Yes. Capgo is intended to be used from CI systems. We've published a guide for [Github Actions](http://localhost:4321/blog/automatic-capacitor-android-build-github-action/), other CI systems should be similar.
