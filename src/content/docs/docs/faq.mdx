...
**Important**: Starting from plugin version **v6.25.0** and **v7.25.0**, the deviceID now persists across app reinstalls. Before these versions, each app reinstall would generate a new deviceID and count as a new MAU.
...
- During development, if you're using an older plugin version (< v6.25.0 / v7.25.0), each reinstall still creates a new MAU
...
You can upgrade or downgrade your plan at any time in your dashboard: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
...
You can cancel your subscription at any time in your dashboard: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
...
Yes you can can at any time in your dashboard: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
