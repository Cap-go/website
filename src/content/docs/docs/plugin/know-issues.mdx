...
Unzip issue. If you zipped your bundle with Window, the format could be incorrect, please use the CLI command `npx @capgo/cli zip BUNDLE_FOLDER` or ZIP with Linux.
...
<figure><img src="/issue_get_config.png" alt="" /><figcaption></figcaption></figure>
