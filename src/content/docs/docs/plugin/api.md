...
For multi-file Delta (manifest) updates, provide the `manifest` array.
...
- `manifest`: File list for Delta (manifest) updates (if using multi-file downloads)
