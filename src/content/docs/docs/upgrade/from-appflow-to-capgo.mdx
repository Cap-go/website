...
description: This comprehensive guide provides detailed instructions on how to successfully transition your application from the Ionic AppFlow platform to the Capgo system, ensuring a smooth and efficient migration process.
sidebar:
  order: 7
---
...
- [GitHub Actions Integration](https://capgo.app/blog/automatic-capacitor-ios-build-github-action/)

#### Option 2: CI/CD Done For You
Let us handle your CI/CD setup with our [managed service](https://cal.com/team/capgo/mobile-ci-cd-done-for-you).
...
For enterprise teams requiring dedicated support during migration, [schedule a call with our team](https://cal.com/team/capgo/capgo-enterprise-inquiry).
