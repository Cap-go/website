...
1. [Register for a Capgo account](https://capgo.app/register)
2. Follow our [quickstart guide](/getting-started/quickstart/)
3. Set up [CI/CD integration](/getting-started/cicd-integration/)
4. Configure [live updates](/live-updates/)
