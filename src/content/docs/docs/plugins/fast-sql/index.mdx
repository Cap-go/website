...
<CardGrid>
  ...
  <Card title="Full SQLite Support" icon="database">
    Complete SQL support with transactions, batch operations, and binary data handling
  </Card>
  <Card title="Sync-Friendly" icon="refresh">
  ...
  <Card title="Transaction Support" icon="shield">
    ACID transactions with configurable isolation levels
  </Card>
  <Card title="Binary Data" icon="file">
