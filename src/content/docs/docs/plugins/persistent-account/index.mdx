...
<CardGrid stagger>
  <Card title="Cross-install persistence" icon="rocket">
    Data survives app uninstall/reinstall cycles 💾
  </Card>
  <Card title="Secure storage" icon="key">
    Secure account data storage with system integration 🔐
  </Card>
  <Card title="Simple API" icon="database">
    Clean read/write interface for account management 📊
  </Card>
