...
description: Learn how to install and configure the Capacitor Navigation Bar plugin to customize the Android navigation bar color and style.
sidebar:
  order: 2
---
...
3. **Configure the plugin**
   ...
   <CardGrid>
     <MicroCard>
       <span slot="title">Set Navigation Bar Color</span>
       ```typescript
     ...
     <MicroCard>
       <span slot="title">Dynamic Theme Support</span>
       ```typescript
