---
title: Google Auth Migration to @capgo/social-login
description: This guide outlines transitioning from the older Google Auth plugin to the newer Capgo social login package, which unifies multiple social authentication providers.
sidebar:
    order: 3
---
