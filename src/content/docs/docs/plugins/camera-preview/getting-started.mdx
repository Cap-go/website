...
description: Learn how to install and use the Camera Preview plugin to display real-time camera feed and capture photos/videos in your Capacitor app.
sidebar:
  order: 2
---
...
Import the plugin and use its methods to control the camera:
...
Takes a picture and returns it as base64 encoded string.
...
Stops video recording and returns the video file path.
...
3. **Optimize performance**
   ...
   - Stop the preview when not in use
...
- Uses Camera2 API
- Supports various camera features based on device capabilities
