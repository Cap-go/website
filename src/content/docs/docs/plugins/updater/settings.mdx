...
<Aside type="tip">
There are additional settings available in the [Capgo web app](https://web.capgo.app/login) that can be configured per channel without requiring a native app release.
</Aside>
