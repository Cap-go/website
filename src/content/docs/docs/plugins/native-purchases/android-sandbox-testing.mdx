...
1. **Add Testing Account**
   ...
   ![Add testing account](/native-purchases/android/sandbox-testing/add-testing-account.png)
...
2. **Create Testing Track**
   ...
   ![Create testing track](/native-purchases/android/sandbox-testing/create-testing-track.png)
...
3. **Create Tester List**
   ...
   ![Create tester list](/native-purchases/android/sandbox-testing/create-tester-list.png)

4. **Join Testing Program**

   Open the opt-in URL from your test device and click the **"Become a tester"** button to enroll.

   ![Join testing](/native-purchases/android/sandbox-testing/join-testing-program.png)
...
5. **Upload Signed APK**
   ...
   ![Upload APK](/native-purchases/android/sandbox-testing/upload-signed-apk.png)
...
6. **Build and Test**
   ...
   ![Test purchase](/native-purchases/android/sandbox-testing/test-purchase-confirmation.png)
