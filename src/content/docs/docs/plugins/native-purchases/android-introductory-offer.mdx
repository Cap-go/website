...
1. **Access Offer Configuration**
   ...
   ![Add offer button](/native-purchases/android/introductory-offer/add-offer-button.png)
...
2. **Select Base Plan**
   ...
   ![Select base plan](/native-purchases/android/introductory-offer/select-base-plan.png)
...
3. **Configure Offer Details**
   ...
   **Eligibility**: Choose who can receive this offer
   ...
   ![Configure offer](/native-purchases/android/introductory-offer/configure-offer-details.png)
