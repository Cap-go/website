...
1. **Navigate to Subscriptions**
   ...
   ![Navigate to subscriptions](/native-purchases/ios/create-subscription/navigate-to-subscriptions.png)
...
3. **Enter Basic Information**
   ...
   **Product ID**: Unique identifier for this subscription (cannot be changed later)
   ...
   ![Enter subscription details](/native-purchases/ios/create-subscription/enter-subscription-info.png)
...
5. **Set Up Pricing**
   ...
   **Price**: Set the subscription price
   ...
   ![Configure pricing](/native-purchases/ios/create-subscription/configure-pricing.png)
...
7. **Add Localizations**
   ...
   **Description**: Brief description of what the subscription includes
   ...
   ![Add localizations](/native-purchases/ios/create-subscription/add-localization.png)
