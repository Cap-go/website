...
| **--delta** | <code>boolean</code> | Upload Delta (manifest) updates to reduce bandwidth |
| **--delta-only** | <code>boolean</code> | Upload only Delta (manifest) updates without full bundle (useful for large apps) |
| **--no-delta** | <code>boolean</code> | Disable Delta (manifest) uploads (useful if `directUpdate` is enabled but you want a full bundle) |
| **--partial** | <code>boolean</code> | [DEPRECATED] Alias for --delta |
| **--partial-only** | <code>boolean</code> | [DEPRECATED] Alias for --delta-only |
...
| **--encrypt-partial** | <code>boolean</code> | Encrypt Delta (manifest) update files (auto-enabled for updater > 6.14.4) |
