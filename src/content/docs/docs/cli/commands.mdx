...
> **Warning**: This command is deprecated and will be removed in the next release. Please use the new encryption system.
...
`npx @capgo/cli bundle decryptV2 [path/to/zip]`
