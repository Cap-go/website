...
By default, Capgo builds iOS apps for App Store distribution (TestFlight + App Store). If you need ad-hoc builds instead (for internal testing, enterprise distribution, or CI artifact collection), you can use the `--ios-distribution` flag.
