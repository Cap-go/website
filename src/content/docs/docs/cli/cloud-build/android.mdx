...
<Steps>
  ...
  5. Select the AAB (or APK) file
        ![Google Play Console select AAB (or APK) file](/native-build-assets/google-play-console-select-apk-file.webp)

        :::caution
        Make sure you select the AAB (or APK) file that you built manually with Android Studio. If this file doesn't use the same keystore as the one you will use for the Capgo build, the Capgo Native Build will fail.
        :::
