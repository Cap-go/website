...
- [Android Certificates Guide](https://capgo.app/cloud/native-builds/certificates/android/)
...
<Aside type="tip">
For detailed instructions with screenshots, see the [Android Certificates Guide](https://capgo.app/cloud/native-builds/certificates/android/).
</Aside>
