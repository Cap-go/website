...
- [Android Certificates Guide](/docs/cloud/native-builds/certificates/android/)
...
<Aside type="tip">
For detailed instructions with screenshots, see the [Android Certificates Guide](/docs/cloud/native-builds/certificates/android/).
</Aside>
