...
<Aside type="tip">
有关详细的分步指南和截图,请访问:
- [Android 证书指南](https://capgo.app/cloud/native-builds/certificates/android/)
...
<Aside type="tip">
有关详细说明和截图,请参阅 [Android 证书指南](https://capgo.app/cloud/native-builds/certificates/android/)。
</Aside>
