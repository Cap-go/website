---
title: 管理凭证
description: 为 iOS 和 Android 构建在本地保存和管理构建凭证
locale: zh
sidebar:
  order: 5
---
...
<Aside type="tip" title="需要帮助获取凭证?">
如果您还没有证书和凭证,请查看这些综合指南:

**iOS:**
- [如何获取 iOS 证书](/docs/cli/cloud-build/ios/#how-to-get-ios-certificates-and-provisioning-profiles) - 分步指南
- [iOS 证书指南 (Capawesome)](https://capawesome.io/cloud/native-builds/certificates/ios/) - 带截图的详细教程
- [博客: 自动 iOS 构建](https://capgo.app/blog/automatic-capacitor-ios-build-github-action/) - 完整的 CI/CD 设置

**Android:**
- [创建密钥库](/docs/cli/cloud-build/android/#creating-a-keystore) - 分步指南
- [Android 证书指南 (Capawesome)](https://capawesome.io/cloud/native-builds/certificates/android/) - 带截图的详细教程
- [博客: 自动 Android 构建](https://capgo.app/blog/automatic-capacitor-android-build-github-action/) - 完整的 CI/CD 设置
</Aside>

<Aside type="caution" title="安全保证">
**您的凭证永远不会永久存储在 Capgo 服务器上:**
- ✅ 仅在活动构建过程中使用
- ✅ 构建完成后自动删除
- ✅ 最长保留时间: 24小时(即使构建失败)
- ✅ 应用直接发送到 App Store/Play Store - 我们不存储任何内容
- ✅ 通过 HTTPS 安全传输
</Aside>
...
<Aside type="note">
**还没有 iOS 证书?** 请参阅 [iOS 构建指南](/docs/cli/cloud-build/ios/#how-to-get-ios-certificates-and-provisioning-profiles) 了解如何创建证书和配置文件的说明。
</Aside>
...
<Aside type="note">
**还没有密钥库?** 请参阅 [Android 构建指南](/docs/cli/cloud-build/android/#creating-a-keystore) 了解如何创建密钥库和设置 Play 商店凭证的说明。
</Aside>
...
对于 CI/CD 环境,**优先使用环境变量**而不是已保存的凭证:
...
- [入门](/docs/cli/cloud-build/getting-started/) - 创建您的第一个构建
- [iOS 构建](/docs/cli/cloud-build/ios/) - iOS 特定的构建配置
- [Android 构建](/docs/cli/cloud-build/android/) - Android 特定的构建配置
