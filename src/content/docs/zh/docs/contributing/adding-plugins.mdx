...
7. ### 创建教程文件
   ...
   创建 `/src/content/plugins/en/your-plugin-name.md`：
...
- [ ] 已在 `/src/content/plugins/en/` 中创建教程
- [ ] 已包含安装说明
- [ ] 已记录 iOS 配置
- [ ] 已记录 Android 配置
- [ ] 已提供使用示例
...
2. 查看生成的翻译：
   - `/src/content/plugins/de/` (德语)
   - `/src/content/plugins/es/` (西班牙语)
   - `/src/content/plugins/fr/` (法语)
   - `/src/content/plugins/it/` (意大利语)
   - `/src/content/plugins/ja/` (日语)
   - `/src/content/plugins/ko/` (韩语)
   - `/src/content/plugins/id/` (印度尼西亚语)
