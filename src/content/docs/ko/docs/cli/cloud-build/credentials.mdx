...
- [iOS 인증서 가이드 (Capgo)](https://capgo.app/cloud/native-builds/certificates/ios/) - 스크린샷이 포함된 자세한 튜토리얼
...
- [Android 인증서 가이드 (Capgo)](https://capgo.app/cloud/native-builds/certificates/android/) - 스크린샷이 포함된 자세한 튜토리얼
