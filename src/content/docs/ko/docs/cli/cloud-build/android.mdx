...
- [Android 인증서 가이드](https://capgo.app/cloud/native-builds/certificates/android/)
...
<Aside type="tip">
스크린샷이 포함된 자세한 지침은 [Android 인증서 가이드](https://capgo.app/cloud/native-builds/certificates/android/)를 참조하세요.
</Aside>
