...
description: 자체 호스팅된 통계 엔드포인트를 만드는 방법
sidebar:
  order: 7
locale: ko
---

다음은 플러그인의 통계를 저장하기 위한 JavaScript 코드 예시입니다
...
* **set**: 앱이 새 번들을 설정할 때
* **set\_fail**: 앱이 설정할 번들의 ID를 찾지 못했을 때
* **update\_fail**: 지연 후 `notifyAppReady`가 호출되지 않았을 때
