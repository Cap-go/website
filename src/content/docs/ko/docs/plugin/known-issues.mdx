...
[Privacy Manifest](https://capacitorjscom/docs/ios/privacy-manifest)(일반적으로 `ios/App/PrivacyInfoxcprivacy`)에 `NSPrivacyAccessedAPICategoryUserDefaults` 사전 키를 추가하세요:
...
[`UserDefaults`](https://developerapplecom/documentation/foundation/userdefaults) API 접근 이유로 [`CA921`](https://developerapplecom/documentation/bundleresources/privacy_manifest_files/describing_use_of_required_reason_api#4278401)을 선언하는 것을 권장합니다
