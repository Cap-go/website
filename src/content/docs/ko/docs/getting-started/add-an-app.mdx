...
Capgo를 시작하기 전에 다음을 확인하세요:
- Capacitor 앱이 설치되고 구성되어 있어야 합니다. [Capacitor 설정 방법 배우기](https://capacitorjs.com/docs/getting-started/)
- Node.js 20 이상이 설치되어 있어야 합니다
- 다음 개발 환경 중 하나:
  - **macOS** - Xcode(iOS 개발용) 및/또는 Android Studio(Android 개발용)
  - **Linux** - Android Studio(Android 개발용)
  - **Windows** - Android Studio(Android 개발용)
