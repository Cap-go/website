...
| `/src/content/plugins/en/` | 영어 튜토리얼 파일 |
...
7. ### 튜토리얼 파일 생성
   ...
   `/src/content/plugins/en/your-plugin-name.md` 생성:
...
- [ ] `/src/content/plugins/en/`에 튜토리얼 생성
- [ ] 설치 지침 포함
- [ ] iOS 구성 문서화
- [ ] Android 구성 문서화
- [ ] 사용 예시 제공
...
2. 생성된 번역 검토:
   - `/src/content/plugins/de/` (독일어)
   - `/src/content/plugins/es/` (스페인어)
   - `/src/content/plugins/fr/` (프랑스어)
   - `/src/content/plugins/it/` (이탈리아어)
   - `/src/content/plugins/ja/` (일본어)
   - `/src/content/plugins/ko/` (한국어)
   - `/src/content/plugins/id/` (인도네시아어)
