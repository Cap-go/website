...
이 작업을 직접 사용하시는 경우, [여기](https://githubcom/sponsors/riderx/)를 통해 제 작업을 지원해주시면 감사하겠습니다.
...
capgo 제공이 적합하지 않다면, [여기](https://githubcom/sponsors/riderx/)에서 여러분이 원하는 조건으로 부트스트랩 메이커를 지원해주세요.
...
> 🚧 안드로이드에서는 HTTP 요청이 허용되지 않습니다. 테스트 목적으로는 [여기서 허용](https://stackoverflowcom/questions/45940861/android-8-cleartext-http-traffic-not-permitted/)하세요.
