...
대시보드에서 언제든지 플랜을 업그레이드하거나 다운그레이드할 수 있습니다: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
...
대시보드에서 언제든지 구독을 취소할 수 있습니다: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)

### 1년치를 미리 결제할 수 있나요?

대시보드에서 언제든지 가능합니다: [https://console.capgo.app/dashboard/settings/plans](https://console.capgo.app/dashboard/settings/plans/)
