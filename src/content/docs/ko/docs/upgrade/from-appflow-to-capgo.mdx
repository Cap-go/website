...
- [GitHub Actions 통합](https://capgo.app/blog/automatic-capacitor-ios-build-github-action/)

#### 옵션 2: CI/CD 서비스
[관리형 서비스](https://cal.com/team/capgo/mobile-ci-cd-done-for-you)로 CI/CD 설정을 맡기세요.
...
마이그레이션 중 전담 지원이 필요한 기업 팀의 경우, [우리 팀과 통화 예약](https://cal.com/team/capgo/capgo-enterprise-inquiry)을 해주세요.
