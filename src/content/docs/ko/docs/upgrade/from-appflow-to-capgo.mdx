...
1. [Capgo 계정 생성](https://capgo.app/register)
2. [빠른 시작 가이드](/getting-started/quickstart/) 따르기
3. [CI/CD 통합](/getting-started/cicd-integration/) 설정
4. [실시간 업데이트](/live-updates/) 구성
