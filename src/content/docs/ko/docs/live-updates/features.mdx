---
title: 기능
description: "핵심 업데이트 시스템부터 고급 배포 제어, 분석 및 팀 협업 기능에 이르기까지 모든 Capgo Live Update 기능에 대한 완전한 참조."
sidebar:
  order: 2
locale: ko
---
...
이 페이지는 Capgo Live Updates에서 사용 가능한 모든 기능에 대한 포괄적인 개요를 제공합니다. 각 기능에는 간단한 설명과 자세한 문서 링크가 포함되어 있습니다.
