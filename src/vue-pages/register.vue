    ...
    <div class="relative w-full max-w-4xl">
      <div class="absolute inset-0 transform -translate-x-4">
        <svg class="blur-3xl filter" style="filter: blur(64px)" width="100%" height="100%" viewBox="0 0 444 775" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path opacity="0.5" d="M48.1169 329.705C48.1169 139.089 -73.495 -1.98068e-05 69.9555 -7.266e-06C213.406 5.27484e-06 444 499.666 444 690.282C444 880.898 213.406 690.282 69.9554 690.282C-73.4951 690.282 48.1168 520.321 48.1169 329.705Z" fill="url(#elin)" />
          <defs>
...
const handleSubmit = async () => {
  ...
  const { data: deleted, error: errorDeleted } = await supabase
    .rpc('is_not_deleted', { email_check: email.value })
  if (errorDeleted)
