  ...
  <section class="py-10 sm:py-12 lg:py-20">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
      <div class="max-w-2xl mx-auto text-center">
        <h1 class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Top Cordova apps</h1>
        <h2 class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-50">
          {{ description }}
        </h2>
        <p class="max-w-xl mx-auto mt-4 text-xs leading-relaxed text-gray-200">Cordova power aproximately {{ usage }}% of apps on Google Play Store</p>
      </div>
