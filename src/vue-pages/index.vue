      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid items-center grid-cols-1 xl:grid-cols-2">
          <div class="px-8 text-center md:mx-auto md:max-w-2xl xl:max-w-none xl:pr-16 xl:text-left">
            <h2 class="text-3xl font-bold text-gray-900 font-pj sm:text-4xl xl:text-5xl">{{ translations['youre_in_good_company'][props.locale] }}</h2>
    ...
    <section class="relative py-20 bg-gray-800 md:my-20">
      ...
      <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="mt-5 text-base text-center text-gray-400">{{ translations['last_update'][props.locale] }}: {{ dayjs().format('MMMM DD, YYYY') }}</p>
        </div>
