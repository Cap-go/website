      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid items-center grid-cols-1 xl:grid-cols-2">
          <div class="px-8 text-center xl:text-left xl:pr-16 md:max-w-2xl md:mx-auto xl:max-w-none">
            ...
            <p class="mt-6 text-lg font-normal text-gray-800 font-pj">Capgo enables development teams at some of the most innovative companies.</p>
          </div>
    ...
    <section class="relative md:my-20 py-20 bg-gray-800">
      ...
      <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="mt-3 text-base leading-relaxed text-gray-300 md:mt-8">Shared transparently with you since December 2021.</p>
    ...
    <section class="py-10 bg-white sm:py-16 lg:py-24">
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">Ship your first update in less than 15 minutes!</p>
        </div>
                ...
                <div class="space-y-12">
                  <div class="flex items-start">
                    ...
                    <div class="ml-5">
                      ...
                      <p class="text-lg font-normal text-gray-600 font-pj">Easily assign users and send the latest update to your private or public testers.</p>
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-10 h-10 text-white bg-gray-900 rounded-full">
                    ...
                    <div class="ml-5">
                      ...
                      <p class="text-lg font-normal text-gray-600 font-pj">When your update is ready, deploy it seamlessly to all your users.</p>
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-10 h-10 text-white bg-gray-900 rounded-full">
                    ...
                    <div class="ml-5">
                      ...
                      <p class="text-lg font-normal text-gray-600 font-pj">Manage all your configurations conveniently through our user-friendly web interface.</p>
                    </div>
                  </div>
                </div>
              </div>
