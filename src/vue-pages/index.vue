...
<template>
  <div>
    <section class="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-3xl mx-auto text-center">
          <p class="inline-flex px-4 py-2 text-base border border-gray-200 rounded-full font-pj">{{ translations['open_source'][props.locale] }}</p>
      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid items-center grid-cols-1 xl:grid-cols-2">
          <div class="px-8 text-center xl:text-left xl:pr-16 md:max-w-2xl md:mx-auto xl:max-w-none">
            <h2 class="font-bold text-gray-900 text-3xl sm:text-4xl xl:text-5xl font-pj">{{ translations['youre_in_good_company'][props.locale] }}</h2>
    ...
    <section class="relative md:my-20 py-20 bg-gray-800">
      ...
      <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="text-base mt-5 text-gray-400 text-center">{{ translations['last_update'][props.locale] }}: {{ dayjs().format('MMMM DD, YYYY') }}</p>
        </div>
    ...
    <section class="py-10 bg-white sm:py-16 lg:py-24">
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">{{ translations['ship_your_first_update_in_less_than_15_minutes'][props.locale] }}</p>
        </div>
    ...
    <section class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-10 py-10 md:py-20">
        <div class="order-last md:order-none">
          <h2 class="text-4xl md:text-7xl font-extrabold my-10">{{ translations['instant_updates'][props.locale] }}</h2>
          <p class="text-lg lg:w-2/3">
                ...
                <div class="space-y-12">
                  ...
                  <div class="flex items-start">
                    ...
                    <div class="ml-5">
                      ...
                      <p class="text-lg font-normal text-gray-600 font-pj">{{ translations['when_your_update_is_ready_deploy_it_seamlessly_to_all_your_users'][props.locale] }}</p>
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-10 h-10 text-white bg-gray-900 rounded-full">
        ...
        <div class="relative rounded-2xl px-6 py-10 bg-gray-700 overflow-hidden shadow-xl sm:px-12 sm:py-20">
          ...
          <div class="relative flex flex-col md:flex-row">
            <div class="sm:text-center md:w-1/2">
              <h3 class="text-white tracking-tight text-3xl sm:text-4xl xl:text-5xl" v-html="translations['push_updates_like_your_commits'][props.locale]" />
            </div>
            <div class="sm:text-center md:w-1/2">
