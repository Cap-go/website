    ...
    <div class="flex justify-between md:my-20">
      <div class="w-full md:w-1/2">
        <div class="pr-4">
          ...
          <p class="mt-10 mb-20 text-sm text-gray-300">{{ m.test_version_in_the_sandbox_app_manage_version_and_channel({}, { locale: props.locale }) }}</p>
        </div>
        <div class="flex items-center space-x-10">
          <span class="flex items-center rounded-[1.125rem] bg-[#EAEAEA] px-4 py-1">
            ...
            <p class="pl-4 text-black">{{ m.speed({}, { locale: props.locale }) }}</p>
          </span>
          <span class="flex items-center rounded-[1.125rem] bg-[#EAEAEA] px-4 py-1">
            ...
            <p class="pl-4 text-black">{{ m.security({}, { locale: props.locale }) }}</p>
          </span>
          <span class="flex items-center rounded-[1.125rem] bg-[#EAEAEA] px-4 py-1">
            ...
            <p class="pl-4 text-black">{{ m.simplicity({}, { locale: props.locale }) }}</p>
          </span>
        </div>
        <div class="mt-8 mb-16">
          <p class="text-sm text-[#bfbfbf]">{{ m.start_building_rich_experiences_with_your_device_and_your_computer({}, { locale: props.locale }) }}</p>
        </div>
