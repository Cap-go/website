  ...
  <section class="py-12 bg-gray-50 sm:py-16 lg:py-20">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="max-w-xl mx-auto text-center xl:max-w-3xl">
        <h2 class="text-3xl font-bold leading-tight text-gray-900 font-pj sm:text-4xl xl:text-5xl">
          {{ m.effortless_ci_cd_solutions({}, { locale: props.locale }) }}
        </h2>
        ...
        <div class="space-y-4 sm:space-y-8">
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              ...
              <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.seamless_integration({}, { locale: props.locale }) }}</h3>
          ...
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              ...
              <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.tailored_configuration({}, { locale: props.locale }) }}</h3>
              <p class="mt-6 text-base text-gray-600 font-pj">
                {{ m.our_team_customizes_the_ci_cd_setup_to_match_your_specific_project_requirements_ensuring_optimal_performance_and_efficiency({}, { locale: props.locale }) }}
              </p>
            </div>
          </div>
        </div>
        <div class="space-y-4 sm:space-y-8">
          <div class="relative">
            ...
            <div class="relative overflow-hidden bg-white shadow-md rounded-xl">
              <div class="p-9">
                ...
                <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.platform_independence({}, { locale: props.locale }) }}</h3>
                <p class="mt-6 text-base text-gray-600 font-pj">
                  {{
                    m.whether_you_use_github_gitlab_or_another_version_control_system_we_adapt_our_configuration_to_fit_your_existing_infrastructure({}, { locale: props.locale })
                  }}
                </p>
              </div>
            </div>
          ...
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              ...
              <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.expert_guidance({}, { locale: props.locale }) }}</h3>
              <p class="mt-6 text-base text-gray-600 font-pj">
                {{
              ...
              <p class="mt-6 text-base text-gray-600 font-pj">
                {{ m.we_already_setup_ci_cd_for_50_apps({}, { locale: props.locale }) }}
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-4xl mx-auto mt-12 text-center">
        <h2 class="text-2xl font-bold text-gray-900 font-pj">{{ m.pricing({}, { locale: props.locale }) }}</h2>
        <p class="mt-4 text-lg text-gray-600">
          <span class="font-bold">{{ m.running_your_ci_cd_costs_300({}, { locale: props.locale }) }}</span
          >, {{ m.appflow_6000_annually({}, { locale: props.locale }) }}<br />
          {{ m.our_one_time_setup_fee_of_2600_combined_with_ci_cd_results_in_less_than_half_the_first_year_fee_of_appflow({}, { locale: props.locale }) }}<br />
          <span class="font-bold"> {{ m.in_5_years_you_save_26100({}, { locale: props.locale }) }}</span>
        </p>
        <a
        ...
        >
          {{ m.setup_ci_cd_now({}, { locale: props.locale }) }}
        </a>
      </div>
    </div>
  </section>
