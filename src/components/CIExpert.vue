    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="max-w-xl mx-auto text-center xl:max-w-3xl">
        ...
        <p class="mt-4 text-lg text-gray-600">
          {{ translations['we_configure_your_ci_cd_pipeline_directly_in_your_preferred_platform_whether_its_github_actions_gitlab_ci_or_others_we_dont_host_ci_cd_or_charge_you_to_maintain_it'][props.locale] }}
        </p>
      </div>
      <div
        class="grid max-w-4xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 sm:mt-12 lg:mt-20 sm:text-left">
        <div class="space-y-4 sm:space-y-8">
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              <svg class="w-12 h-12 mx-auto text-blue-600 sm:mx-0" xmlns="http://www.w3.org/2000/svg" fill="none"
              ...
              <p class="mt-6 text-base text-gray-600 font-pj">
                {{ translations['we_set_up_your_ci_cd_workflow_to_work_seamlessly_with_your_current_development_process_no_need_to_switch_platforms_or_learn_new_tools'][props.locale] }}
              </p>
            </div>
          </div>
        ...
        <div class="space-y-4 sm:space-y-8">
          <div class="relative">
            <div class="absolute -inset-1">
              <div class="w-full h-full rotate-180 opacity-30 blur-lg filter"
      ...
      <div class="max-w-4xl mx-auto mt-12 text-center">
        ...
        <p class="mt-4 text-lg text-gray-600">
          ...
          {{
            translations['our_one_time_setup_fee_of_2600_combined_with_ci_cd_results_in_less_than_half_the_first_year_fee_of_appflow']
          }}<br />
          <span class="font-bold"> {{ translations['in_5_years_you_save_26100'][props.locale] }}</span>
        </p>
        <a href="https://cal.com/martindonadieu/mobile-ci-cd-done-for-you"
