  ...
  <section class="py-12 bg-gray-50 sm:py-16 lg:py-20">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="space-y-4 sm:space-y-8">
          ...
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              ...
              <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.tailored_configuration() }}</h3>
              <p class="mt-6 text-base text-gray-600 font-pj">
                {{ m.our_team_customizes_the_ci_cd_setup_to_match_your_specific_project_requirements_ensuring_optimal_performance_and_efficiency() }}
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="relative">
            ...
            <div class="relative overflow-hidden bg-white shadow-md rounded-xl">
              <div class="p-9">
                ...
                <h3 class="mt-8 text-2xl font-bold text-gray-900 font-pj sm:mt-10">{{ m.platform_independence() }}</h3>
                <p class="mt-6 text-base text-gray-600 font-pj">
                  {{ m.whether_you_use_github_gitlab_or_another_version_control_system_we_adapt_our_configuration_to_fit_your_existing_infrastructure() }}
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="max-w-4xl mx-auto mt-12 text-center">
        <h2 class="text-2xl font-bold text-gray-900 font-pj">{{ m.pricing() }}</h2>
        <p class="mt-4 text-lg text-gray-600">
          <span class="font-bold">{{ m.running_your_ci_cd_costs_300() }}</span
          >, {{ m.appflow_6000_annually() }}<br />
          {{ m.our_one_time_setup_fee_of_2600_combined_with_ci_cd_results_in_less_than_half_the_first_year_fee_of_appflow() }}<br />
          <span class="font-bold"> {{ m.in_5_years_you_save_26100() }}</span>
        </p>
        <a
