...
<template>
  <section id="plans">
    <div class="grid grid-cols-1 mt-6 lg:grid-cols-4 lg:gap-8 sm:mt-8 lg:mt-10">
      ...
      >
        <div
          v-if="plan.name === 'Maker'"
          class="absolute top-0 right-0 flex items-start -mt-8"
        >
          <svg
            class="w-auto h-16 text-blue-600"
            viewBox="0 0 83 64"
            fill="currentColor"
        ...
        <div class="px-4 py-5 sm:p-6">
          ...
          <p
            class="mt-8 text-xs font-semibold tracking-widest text-gray-500 uppercase"
          >
            You get
          </p>
          ...
          <ul class="mt-8 space-y-4 text-black">
            <li class="flex items-center">
              <svg
                class="w-5 h-5 mr-2 text-blue-600 shrink-0 fill-blue-600"
                xmlns="http://www.w3.org/2000/svg"
                height="1em"
                fill="currentColor"
                viewBox="0 0 448 512"
              ...
              <span
                ><span class="font-bold">{{
                  numberWithSpaces(updateCalc(plan))
                }}</span
            ...
            <li class="flex items-center">
              <svg
                class="w-5 h-5 mr-2 text-blue-600 shrink-0"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                height="1em"
                viewBox="0 0 448 512"
            ...
            <li class="flex items-center">
              ...
              <span
                ><span class="font-bold">{{
                  numberWithSpaces(plan.bandwidth)
                }}</span>
                GB/mo of Bandwidth</span
              >
            </li>
