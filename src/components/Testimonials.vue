...
<template>
  <section class="bg-gray-800">
    <div
      class="p-0 m-0 leading-6 text-black align-baseline border-0 border-solid"
    >
      <div
      ...
      >
        ...
        <div
          class="flex p-0 m-0 align-baseline border-0 border-solid items-center md:flex-col flex-wrap md:max-h[1000px]"
        >
