  ...
  <header class="relative py-2">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between">
        <div class="flex-shrink-0">
          <a href="/" title="Capgo home" aria-label="Capgo home" class="flex text-4xl font-medium font-prompt items-center pr-3">
    ...
    <div :class="{ hidden: !menuMobile }">
      <div class="px-2 pt-2 mt-2 pb-3 space-y-1 bg-gray-700">
        ...
        <a href="https://docs.capgo.app/" title="Documentation" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
          Documentation
        </a>
        <a
          href="https://web.capgo.app/login"
