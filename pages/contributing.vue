...
<template>
  <div class="prose prose-sm m-auto text-left px-3">
    ...
    <ol>
      <li><code>npm run lint</code> passes - this will check Rust and JavaScript code for common mistakes and errors using <code>Swiftlint</code> (for Swift) and <code>eslint</code> (for JavaScript and Java)</li>
    </ol>
