    ...
    >
      ...
      >
        <div class="my-0 mx-auto text-center sm:mx-auto" style="max-width: 950px;">
          ...
          >
            <strong class="" style="line-height: 72px;">CapacitorJS</strong><span class="text-indigo-600" style="line-height: 72px;"><strong class="" style="line-height: 72px;">
              Code Review and Consulting</strong></span><strong class="" style="line-height: 72px;"> Services</strong>
          </h1>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <h4 class="my-2 text-xl font-medium leading-6 filter-none">
              <strong class="font-bold">Improved code readability</strong><br class="">
            </h4>
            <p
              class="block mt-auto mb-2 text-lg whitespace-normal "
            >
          ...
          >
            ...
            >
              ...
              production.<strong class="font-bold" />
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <h5
            ...
            style="line-height: 42px;"
          >
            <strong class="font-bold" style="line-height: 42px;">Opportunity for juniors to develop skills<br
              class=""
              style="line-height: 42px;"
            ></strong>
          </h5>
          ...
          <div role="listitem" class="text-slate-900">
            ...
            >
              ...
              >
                <p class="mt-0 mb-2 italic">
                  I would have
                  <strong class="italic font-bold">no hesitation in recommending  Capgo</strong>
      ...
      <div class="flex flex-col md:flex-row w-full">
        ...
        <div class="flex flex-col">
          <h3
            ...
            style="line-height: 72px;"
          >
            <strong class="text-6xl text-left" style="line-height: 72px;">Let's work </strong><span class="text-6xl text-left text-teal-300" style="line-height: 72px;"><strong class="font-medium" style="line-height: 72px;">together!</strong></span><br class="text-6xl text-left" style="line-height: 72px;">
          </h3>
