...
useHead({
  ...
  meta: createMeta(
    title,
    'Move forward with confidence. Capgo is the enterprise-grade cloud platform for Capacitor applications.'),
})
</script>
...
<template>
  <section class="py-12 bg-gray-50 sm:py-16 lg:py-20">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <Calculator v-if="plansAll && payg_base" class="pb-6 bg-gray-50 sm:pb-10 lg:pb-14 pt-3 sm:pt-6 lg:pt-10" :yearly="yearly" :pricing="plansAll" :payg-base="payg_base" :payg-units="payg_units" />
