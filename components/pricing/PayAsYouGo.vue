              ...
              <div class="md:col-span-3 xl:pr-2 space-y-9">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-600 font-pj">
                      <span class="font-bold">{{ payg?.mau.toLocaleString() }}</span> users included, then ${{ payg?.mau_unit }}/u
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-600 font-pj">
                      <span class="font-bold">{{ toTb(payg?.bandwidth) }}</span> TB included, then ${{ payg?.bandwidth_unit }}/GB additional
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-600 font-pj">
                      <span class="font-bold">{{ payg?.storage.toLocaleString() }}</span> GB included, then ${{ payg?.storage_unit }}/GB additional
                    </p>
                  </div>
                </div>
              </div>
