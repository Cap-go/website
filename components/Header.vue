  ...
  <header class="relative py-4 md:py-6">
    <div class="px-4 pb-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between">
        ...
        <div class="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
          ...
          <a href="/doc" title="Documentation" class="text-base font-medium transition-all duration-200 rounded focus:outline-none font-pj hover:text-opacity-50 focus:ring-1 focus:ring-gray-900 focus:ring-offset-2"> Documentation </a>
    ...
    <div :class="{ hidden: !menuMobile }">
      <div class="px-2 pt-2 pb-3 space-y-1 bg-gray-700">
        ...
        <a href="/doc" title="Documentation" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Docummentation</a>
        ...
        <a
          href="https://discord.gg/VnYRvBfgA6" title="Communauty" target="_blank" class="
                          bg-gray-900
                          text-white
                            block
                            rounded-md
