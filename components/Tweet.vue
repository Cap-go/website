...
<template>
    <div class="p-4 mx-auto md:mx-3 mt-0 mb-6 max-w-80 md:max-w-72 align-baseline border border-solid border-zinc-700 bg-gray-800"
        ...
        <div class="flex justify-between p-0 m-0 align-baseline border-0 border-solid">
            ...
            <svg viewBox="0 0 20 20" fill="none" width="20" height="20" role="img" color="#03A9F4" size="20"
                ...
                <path
                    ...
                    fill="#03A9F4" class="border-0 border-solid"></path>
            </svg>
        </div>
        <p
            ...
            class="p-0 m-0 align-baseline border-0 border-solid"></span>
        </p>
    </div>
</template>